...
public class FixYAMLFactory extends YAMLFactory {
    ...
    protected YAMLGenerator _createGenerator(Writer out, IOContext context) throws IOException {
        ...
        return new YAMLGenerator(context, FixYAMLFactory.this._generatorFeatures, feats,
                FixYAMLFactory.this._quotingChecker, FixYAMLFactory.this._objectCodec, out, FixYAMLFactory.this._version) {
