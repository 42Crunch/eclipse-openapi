...
public class DataFormatString extends DataFormat {
    ...
    public DataFormatString(@NotNull String name,
            ...
            @NotNull BigInteger minLength,
            @NotNull BigInteger maxLength) {
        super(name, description, "string", format, null, example, defaultProp,
