...
import com.xliic.openapi.bigfiles.jcef.JCEFBigFilesPanel;
...
public class WebFileEditorPart extends EditorPart {
	...
	private static final Image BIG_FILES_EDITOR_IMAGE = OpenAPIImages.TagsAnnoPanel.createImage();
	...
	public void init(IEditorSite site, IEditorInput input) throws PartInitException {
		...
		} else if (BIG_FILES_EDITOR_ID.equals(resId)) {
			setTitleImage(BIG_FILES_EDITOR_IMAGE);
		}
	}
	...
	public void createPartControl(Composite parent) {
		...
		switch (webFile.getResourceId()) {
          ...
          case TAGS_EDITOR_ID:
        	  ...
        	  break;
          case BIG_FILES_EDITOR_ID:
        	  webEditor = new JCEFBigFilesPanel(project, parent, webFile);
        	  break;
          default:
