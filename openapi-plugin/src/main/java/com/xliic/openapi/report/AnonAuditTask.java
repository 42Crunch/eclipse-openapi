...
public class AnonAuditTask extends Task.Backgroundable {
    ...
    public AnonAuditTask(@NotNull Project project, @NotNull VirtualFile file, @NotNull AuditService.Callback callback) {
