...
import static com.crunch42.openapi.parser.pointer.LocationUtils.pointer;
...
public class OpenApiTreeNode {
    ...
    public OpenApiTreeNode(String key) {
        this(key, new Location(), true, key, key,
                GENERAL.equals(key) ? GENERAL_POINTER : pointer(key),0, true, true);
    }
