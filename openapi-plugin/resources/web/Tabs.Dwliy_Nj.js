import { f as r, R as S, a8 as ie, K as de, e as N, T as v, j as x, S as ue } from "./TriangleExclamation.pAuQxBo5.js";
...
function ve(e) {
  const t = e + "CollectionProvider", [o, n] = L(t), [c, s] = o(t, {
    ...
    const { scope: h, children: m, ...C } = p, E = S.useRef(null), y = P(b, E), R = s(d, h);
    return S.useEffect(() => (R.itemMap.set(E, {
      ref: E,
      ...C
    }), () => void R.itemMap.delete(E))), /* @__PURE__ */ S.createElement(w, {
      [f]: "",
      ref: y
    }, m);
  });
...
const O = "rovingFocusGroup.onEntryFocus", Ee = {
  ...
  const { __scopeRovingFocusGroup: o, focusable: n = !0, active: c = !1, ...s } = e, a = z(), i = Re(_e, o), l = i.currentTabStopId === a, d = Z(o);
...
}), Ke = "TabsTrigger", ze = /* @__PURE__ */ r.forwardRef((e, t) => {
...
}), Ye = "TabsContent", qe = /* @__PURE__ */ r.forwardRef((e, t) => {
  const { __scopeTabs: o, value: n, forceMount: c, children: s, ...a } = e, i = V(Ye, o), l = ee(i.baseId, n), d = te(i.baseId, n), f = n === i.value, u = r.useRef(f);
  return r.useEffect(() => {
