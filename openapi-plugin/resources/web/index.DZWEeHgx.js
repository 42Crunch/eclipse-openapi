import { y as j, R as g, Z as D, j as m, a1 as G, f as i, a6 as Z, x as $, z as L, A as w, a7 as J } from "./TriangleExclamation.Lif_Buog.js";
function Q(e) {
  ...
  const s = e + "CollectionItemSlot", C = "data-radix-collection-item", E = G(s), b = g.forwardRef(
    (f, t) => {
      ...
      return g.useEffect(() => (T.itemMap.set(c, { ref: c, ...n }), () => void T.itemMap.delete(c))), /* @__PURE__ */ m.jsx(E, { [C]: "", ref: x, children: d });
    }
  );
  b.displayName = s;
  function F(f) {
...
var ce = i.forwardRef((e, o) => {
  ...
  (e, o) => {
    const {
      ...
      children: I,
      ...R
    } = e, _ = J(), p = v || _, s = re(U, u), C = s.currentTabStopId === p, E = K(u), { onFocusableItemAdd: b, onFocusableItemRemove: F, currentTabStopId: f } = s;
    return i.useEffect(() => {
      if (r)
        return b(), () => F();
