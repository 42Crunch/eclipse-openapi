import { e as P, I as Ae, j as I, w as Pt, ae as yt, v as Re, V as Ut, y as Pe } from "./webapp.CeAUXIIl.js";
...
function Ke(t, e) {
  const n = G(t, !0, e === "fixed"), o = n.top + t.clientTop, i = n.left + t.clientLeft, r = j(t) ? J(t) : U(1), s = t.clientWidth * r.x, c = t.clientHeight * r.y, a = i * r.x, l = o * r.y;
  return {
    width: s,
    height: c,
    x: a,
...
function Ge(t, e) {
  ...
  for (; _(s) && !Q(s); ) {
    const c = B(s), a = Et(s);
    !a && c.position === "fixed" && (i = null), (r ? !a && !i : !a && c.position === "static" && !!i && ["absolute", "fixed"].includes(i.position) || rt(s) && !a && te(t, s)) ? o = o.filter((f) => f !== s) : i = c, s = K(s);
  }
  return e.set(t, o), o;
}
function Je(t) {
