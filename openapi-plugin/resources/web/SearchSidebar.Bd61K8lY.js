...
function N({
  ...
  return /* @__PURE__ */ e.jsx(R, { children: i.filter(
    (o) => a === void 0 || o.label.toLowerCase().includes(a.toLowerCase())
  ).map((o) => o.id === d ? /* @__PURE__ */ e.jsxs(P, { children: [
    /* @__PURE__ */ e.jsx("span", { className: "label", children: o.label }),
    (l == null ? void 0 : l[o.id]) !== void 0 && /* @__PURE__ */ e.jsx(v, { message: l[o.id] }),
...
function v({ message: i }) {
  return /* @__PURE__ */ e.jsx(I, { children: /* @__PURE__ */ e.jsxs(T, { children: [
    /* @__PURE__ */ e.jsx(z, { asChild: !0, children: /* @__PURE__ */ e.jsx(V, { children: /* @__PURE__ */ e.jsx(y, {}) }) }),
    /* @__PURE__ */ e.jsx(F, { children: /* @__PURE__ */ e.jsx(q, { children: i }) })
  ] }) });
}
const R = s.ul`
  padding: 0;
...
function Z(i) {
  ...
  return /* @__PURE__ */ e.jsx(D, { ...i, selected: d, onSelected: c });
}
function D({
  render: i,
  renderButtons: d,
  ...
  const [g, $] = h.useState(""), [p, f] = h.useState(!0), S = a.map((n) => n.items).flat().length;
  return /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    ...
    p && /* @__PURE__ */ e.jsxs(H, { children: [
      ...
      d && /* @__PURE__ */ e.jsx(J, { children: d() })
    ] }),
    /* @__PURE__ */ e.jsx(G, { expanded: p, children: r !== void 0 ? i(r) : c == null ? void 0 : c() })
  ] });
}
const H = s.div`
  position: absolute;
