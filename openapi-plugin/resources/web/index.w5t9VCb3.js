import { f as O, L as Se, j as X, A as Rt, az as yt, z as Ee, _ as Kt, y as De } from "./TriangleExclamation.BF0l2qmp.js";
const Le = ["top", "right", "bottom", "left"], Z = Math.min, H = Math.max, ft = Math.round, lt = Math.floor, j = (t) => ({
  x: t,
  y: t
}), Te = {
  left: "right",
...
function Vt(t, e, n) {
  ...
  const r = V(e), s = Ct(e), c = Pt(s), l = U(e), a = r === "y", f = o.x + o.width / 2 - i.width / 2, u = o.y + o.height / 2 - i.height / 2, h = o[c] / 2 - i[c] / 2;
  let d;
  switch (l) {
    case "top":
      d = {
...
const Ve = (t) => ({
  ...
  async fn(e) {
    ...
    const T = y / 2 - v / 2, N = P / 2 - m[p] / 2 - 1, L = Z(u[g], N), $ = Z(u[x], N), k = L, S = P - m[p] - $, C = P / 2 - m[p] / 2 + T, F = vt(k, C, S), E = !l.arrow && tt(i) != null && C !== F && r.reference[p] / 2 - (C < k ? L : $) - m[p] / 2 < 0, D = E ? C < k ? C - k : C - S : 0;
    return {
      [d]: h[d] + D,
      data: {
        [d]: F,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if ((n = r.arrow) != null && n.alignmentOffset)
        return {};
      const g = U(i), x = V(c), b = U(c) === c, y = await (l.isRTL == null ? void 0 : l.isRTL(a.floating)), v = h || (b || !m ? [ut(c)] : Ne(c)), R = p !== "none";
...
async function Ye(t, e) {
  const {
    ...
    platform: o,
    elements: i
  } = t, r = await (o.isRTL == null ? void 0 : o.isRTL(i.floating)), s = U(n), c = tt(n), l = V(n) === "y", a = Jt.has(s) ? -1 : 1, f = r && l ? -1 : 1, u = q(e, t);
  let {
    mainAxis: h,
    crossAxis: d,
    alignmentAxis: p
...
const Xe = function(t) {
  ...
  return t === void 0 && (t = {}), {
    ...
    fn(e) {
      ...
      if (a) {
        var g, x;
        const b = h === "y" ? "width" : "height", y = Jt.has(U(i)), v = r.reference[u] - r.floating[b] + (y && ((g = s.offset) == null ? void 0 : g[u]) || 0) + (y ? 0 : w.crossAxis), R = r.reference[u] + r.reference[b] + (y ? 0 : ((x = s.offset) == null ? void 0 : x[u]) || 0) - (y ? w.crossAxis : 0);
        p < v ? p = v : p > R && (p = R);
      }
      return {
        [h]: d,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const {
        ...
        ...a
      } = q(t, e), f = await ot(e, a), u = U(i), h = tt(i), d = V(i) === "y", {
        width: p,
        height: m
      } = r.floating;
      let w, g;
      u === "top" || u === "bottom" ? (w = u, g = h === (await (s.isRTL == null ? void 0 : s.isRTL(c.floating)) ? "start" : "end") ? "left" : "right") : (g = u, w = h === "end" ? "top" : "bottom");
      const x = m - f.top - f.bottom, b = p - f.left - f.right, y = Z(m - f[w], x), v = Z(p - f[g], b), R = !e.middlewareData.shift;
      let P = y, T = v;
...
const Rn = Xe, On = qe, Pn = je, Cn = Ze, Sn = Ie, Ut = Ve, En = Ue, Dn = (t, e, n) => {
