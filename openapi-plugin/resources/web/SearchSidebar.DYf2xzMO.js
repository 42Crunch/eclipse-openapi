...
function R({
  ...
  return /* @__PURE__ */ e.jsx(A, { children: i.filter(
    (o) => a === void 0 || o.label.toLowerCase().includes(a.toLowerCase())
  ).map((o) => o.id === c ? /* @__PURE__ */ e.jsxs(N, { children: [
    /* @__PURE__ */ e.jsx("span", { className: "label", children: o.label }),
    (l == null ? void 0 : l[o.id]) !== void 0 && /* @__PURE__ */ e.jsx(f, { message: l[o.id] }),
...
function f({ message: i }) {
  return /* @__PURE__ */ e.jsx(B, { children: /* @__PURE__ */ e.jsxs(T, { children: [
    /* @__PURE__ */ e.jsx(I, { asChild: !0, children: /* @__PURE__ */ e.jsx(V, { children: /* @__PURE__ */ e.jsx(F, {}) }) }),
    /* @__PURE__ */ e.jsx(z, { children: /* @__PURE__ */ e.jsx(q, { children: i }) })
  ] }) });
}
const A = r.ul`
  padding: 0;
...
function _(i) {
  ...
  const [c, d] = g.useState(
    i.defaultSelection || {
      sectionId: (l = (a = i.sections) == null ? void 0 : a[0]) == null ? void 0 : l.id,
      itemId: (x = (s = (u = (o = i.sections) == null ? void 0 : o[0]) == null ? void 0 : u.items) == null ? void 0 : s[0]) == null ? void 0 : x.id
    }
  );
  return /* @__PURE__ */ e.jsx(D, { ...i, selected: c, onSelected: d });
}
function D({
  render: i,
  renderButtons: c,
  ...
  return /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    !p && /* @__PURE__ */ e.jsx(E, { children: /* @__PURE__ */ e.jsx(
      m,
      {
        onClick: (n) => {
    ...
    p && /* @__PURE__ */ e.jsxs(H, { children: [
      ...
      /* @__PURE__ */ e.jsx(O, { children: a.map((n) => n.items.length === 0 && w && n.menu === void 0 ? null : /* @__PURE__ */ e.jsxs(C.Fragment, { children: [
        ...
        /* @__PURE__ */ e.jsx(
          R,
          {
            selected: (s == null ? void 0 : s.sectionId) == n.id ? s.itemId : void 0,
    ...
    /* @__PURE__ */ e.jsx(G, { expanded: p, children: s !== void 0 ? i(s) : d == null ? void 0 : d() })
  ] });
}
const H = r.div`
  position: absolute;
