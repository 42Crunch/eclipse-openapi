import { f as s, j as p, A as S, z as Z, Y as $, X as J, _ as H, C as m, Z as N, a5 as Q, ab as ee, ay as te } from "./TriangleExclamation.BF0l2qmp.js";
import { c as G, R as oe, A as re, C as ne, a as se } from "./index.w5t9VCb3.js";
...
var R = "Tooltip", [pe, _] = A(R), B = (e) => {
  const {
    ...
    caller: R
  }), w = s.useMemo(() => g ? T.current ? "delayed-open" : "instant-open" : "closed", [g]), E = s.useCallback(() => {
...
var b = "TooltipContent", q = s.forwardRef(
  (e, o) => {
    const t = fe(b, e.__scopeTooltip), { forceMount: r = t.forceMount, side: n = "top", ...i } = e, l = _(b, e.__scopeTooltip);
  ...
  const t = _(b, e.__scopeTooltip), r = O(b, e.__scopeTooltip), n = s.useRef(null), i = H(o, n), [l, v] = s.useState(null), { trigger: a, onClose: d } = t, c = n.current, { onPointerInTransitChange: f } = r, h = s.useCallback(() => {
    v(null), f(!1);
  }, [f]), u = s.useCallback(
    (x, y) => {
      const T = x.currentTarget, g = { x: x.clientX, y: x.clientY }, C = ye(g, T.getBoundingClientRect()), w = Ce(g, C), E = ge(y.getBoundingClientRect()), P = be([...w, ...E]);
      v(P), f(!0);
    },
    [f]
  );
  return s.useEffect(() => () => h(), [h]), s.useEffect(() => {
    ...
    if (l) {
      const x = (y) => {
        const T = y.target, g = { x: y.clientX, y: y.clientY }, C = (a == null ? void 0 : a.contains(T)) || (c == null ? void 0 : c.contains(T)), w = !me(g, l);
        C ? h() : w && (h(), d());
      };
