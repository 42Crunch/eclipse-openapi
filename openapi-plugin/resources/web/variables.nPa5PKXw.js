import { j as vt, v as Ne } from "./TriangleExclamation.DXu4kS4a.js";
import { d as Be, a as et, y as rn, k as on, n as sn, o as an, z as un, q as tt, A as ln, p as fn, r as cn, t as pn, c as ut, i as hn } from "./slice.CWBRDdMB.js";
...
` + m), E;
      ...
      function E(i, _) {
        if (_ = _ || {}, Object.keys(_).forEach(function(v) {
          if (u.indexOf(v) === -1)
            throw new a('Unknown option "' + v + '" is met in definition of "' + i + '" YAML type.');
...
function qi(t, r, w, n) {
  let o;
  return en("request", r, n, (a) => (o === void 0 && (o = Li(t, w, r.path, r.method)), o));
}
function Ji(t, r) {
  return tn(t, r, {}, [], () => ({
    body: void 0,
