import { T as e, e as i, j as r } from "./TriangleExclamation.BF0l2qmp.js";
import { a as c } from "./index.esm.dAAmnfiQ.js";
import { D as p } from "./DescriptionTooltip.BWFUYW-o.js";
function m({
  label: n,
  name: l,
  disabled: t,
  ...
  const {
    field: d,
    fieldState: { error: o, invalid: s }
  } = c({
    name: l
  });
  return /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
    /* @__PURE__ */ r.jsxs(x, { $invalid: s, children: [
      ...
      /* @__PURE__ */ r.jsx("textarea", { ...d, disabled: t })
    ] }),
