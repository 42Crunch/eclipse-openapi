import { z as j, R as g, _ as D, j as m, a5 as G, f as i, X, y as $, A as L, C as w, Y as J } from "./TriangleExclamation.DrtDYmuA.js";
function Q(e) {
...
var ce = i.forwardRef((e, o) => {
  const {
    ...
    ...R
  } = e, E = i.useRef(null), b = D(o, E), F = Z(v), [f, t] = X({
    prop: I,
    defaultProp: C ?? null,
    onChange: _,
    caller: y
