import { c as Rs, u as Ds, b as xs, W as Oi } from "./TriangleExclamation.BLKAXJ8l.js";
const qs = {
  ready: !1,
...
}), { loadEnv: vo, saveEnv: $o, showEnvWindow: Po } = Ii.actions, jo = Ds, Fo = xs, Uo = Ii.reducer, Mo = [
  "get",
  "put",
  "post",
  "delete",
...
function Ks() {
  return Hn || (Hn = 1, Object.defineProperty(ce, "__esModule", { value: !0 }), ce.preserveLocationKey = ce.preserveFormattingKey = ce.preserveRootRangeKey = void 0, ce.preserveRootRangeKey = /* @__PURE__ */ Symbol("preserve-root-location"), ce.preserveFormattingKey = /* @__PURE__ */ Symbol("preserve-formatting"), ce.preserveLocationKey = /* @__PURE__ */ Symbol("preserve-location")), ce;
}
var zn;
function ot() {
  if (zn) return oe;
  ...
  function t(f, u) {
    var p;
    return (p = f?.[e.preserveFormattingKey]) === null || p === void 0 ? void 0 : p[u];
  }
  function n(f, u, p) {
  ...
  function i(f, u) {
    var p;
    return (p = f?.[e.preserveLocationKey]) === null || p === void 0 ? void 0 : p[u];
  }
  function s(f, u, p) {
...
var He = {}, mt = {};
const In = /* @__PURE__ */ Symbol.for("yaml.alias"), pn = /* @__PURE__ */ Symbol.for("yaml.document"), be = /* @__PURE__ */ Symbol.for("yaml.map"), Ni = /* @__PURE__ */ Symbol.for("yaml.pair"), ae = /* @__PURE__ */ Symbol.for("yaml.scalar"), Ge = /* @__PURE__ */ Symbol.for("yaml.seq"), te = /* @__PURE__ */ Symbol.for("yaml.node.type"), pe = (e) => !!e && typeof e == "object" && e[te] === In, we = (e) => !!e && typeof e == "object" && e[te] === pn, Te = (e) => !!e && typeof e == "object" && e[te] === be, R = (e) => !!e && typeof e == "object" && e[te] === Ni, F = (e) => !!e && typeof e == "object" && e[te] === ae, Ne = (e) => !!e && typeof e == "object" && e[te] === Ge;
function x(e) {
...
const Bi = (e) => (F(e) || x(e)) && !!e.anchor, z = /* @__PURE__ */ Symbol("break visit"), Li = /* @__PURE__ */ Symbol("skip children"), le = /* @__PURE__ */ Symbol("remove node");
function ke(e, t) {
  const n = _i(t);
...
class C {
  constructor(t, n) {
    this.docStart = null, this.docEnd = !1, this.yaml = Object.assign({}, C.defaultYaml, t), this.tags = Object.assign({}, C.defaultTags, n);
  }
  clone() {
    const t = new C(this.yaml, this.tags);
...
function Gs(e, t) {
  ...
  return {
    ...
    setAnchors: () => {
      for (const r of n) {
        const o = i.get(r);
        if (typeof o == "object" && o.anchor && (F(o.node) || x(o.node)))
  ...
  toJS(t, { mapAsMap: n, maxAliasCount: i, onAnchor: s, reviver: r } = {}) {
    ...
    if (typeof s == "function")
      for (const { count: f, res: u } of o.anchors.values())
        s(u, f);
    return typeof r == "function" ? xe(r, { "": l }, "", l) : l;
  }
}
class at extends Tn {
  constructor(t) {
  ...
  resolve(t, n) {
    let i;
    n?.aliasResolveCache ? i = n.aliasResolveCache : (i = [], ke(t, {
      Node: (r, o) => {
        (pe(o) || Bi(o)) && i.push(o);
      }
...
class $ extends Tn {
  ...
  toJSON(t, n) {
    return n?.keep ? this.value : ee(this.value, t, n);
  }
  toString() {
...
function nt(e, t, n) {
  if (we(e) && (e = e.contents), q(e))
    return e;
  if (R(e)) {
    const g = n.schema[be].createNode?.(n.schema, null, n);
  ...
  const p = u?.createNode ? u.createNode(n.schema, e, n) : typeof u?.nodeClass?.from == "function" ? u.nodeClass.from(n.schema, e, n) : new $(e);
...
class Mi extends Tn {
  ...
  clone(t) {
    ...
    return t && (n.schema = t), n.items = n.items.map((i) => q(i) || R(i) ? i.clone(t) : i), this.range && (n.range = this.range.slice()), n;
  }
  /**
  ...
  getIn(t, n) {
    const [i, ...s] = t, r = this.get(i, !0);
    return s.length === 0 ? !n && F(r) ? r.value : r : x(r) ? r.getIn(s, n) : void 0;
  }
  hasAllNullValues(t) {
    return this.items.every((n) => {
      if (!R(n))
        return !1;
      const i = n.value;
      return i == null || t && F(i) && i.value == null && !i.commentBefore && !i.comment && !i.tag;
    });
  }
  /**
...
function Mt(e, t, n = "flow", { indentAtStart: i, lineWidth: s = 80, minContentWidth: r = 20, onFold: o, onOverflow: l } = {}) {
  ...
  let y, m, k = !1, b = -1, E = -1, B = -1;
  n === dn && (b = ei(e, b, t.length), b !== -1 && (g = b + f));
  for (let A; A = e[b += 1]; ) {
    if (n === Lt && A === "\\") {
      switch (E = b, e[b + 1]) {
        case "x":
    ...
    if (A === `
`)
      n === dn && (b = ei(e, b, t.length)), g = b + t.length + f, y = void 0;
    else {
      if (A === " " && m && m !== " " && m !== `
` && m !== "	") {
        const _ = e[b + 1];
...
` && _ !== "	" && (y = b);
      ...
      if (b >= g)
        if (y)
          u.push(y), g = y + f, y = void 0;
        else if (n === Lt) {
          for (; m === " " || m === "	"; )
            m = A, A = e[b += 1], k = !0;
          const _ = b > B + 1 ? b - 2 : E - 1;
          if (p[_])
            return e;
          u.push(_), p[_] = !0, g = _ + f, y = void 0;
        } else
          k = !0;
    }
    m = A;
  ...
  for (let A = 0; A < u.length; ++A) {
    const _ = u[A], O = u[A + 1] || e.length;
    _ === 0 ? L = `
${t}${e.slice(0, O)}` : (n === Lt && p[_] && (L += `${e[_]}\\`), L += `
${t}${e.slice(_ + 1, O)}`);
  }
  return L;
}
...
` && O !== "	" && O !== " ")
  ...
  const k = m.indexOf(`
`);
  k === -1 ? g = "-" : n === m || k !== m.length - 1 ? (g = "+", r && r()) : g = "", m && (n = n.slice(0, -m.length), m[m.length - 1] === `
` && (m = m.slice(0, -1)), m = m.replace(yn, `$&${u}`));
  let b = !1, E, B = -1;
...
${f}`);
  if (o) {
    const y = (b) => b.default && b.tag !== "tag:yaml.org,2002:str" && b.test?.test(g), { compat: m, tags: k } = t.doc.schema;
    if (k.some(y) || m?.some(y))
      return qe(r, t);
  }
...
function ct(e, t, n, i) {
  ...
  const f = (p) => {
    switch (p) {
      case $.BLOCK_FOLDED:
      case $.BLOCK_LITERAL:
        return s || r ? qe(o.value, t) : _t(o, t, n, i);
      case $.QUOTE_DOUBLE:
        return tt(o.value, t);
      case $.QUOTE_SINGLE:
        return gn(o.value, t);
  ...
  let u = f(l);
  if (u === null) {
    const { defaultKeyType: p, defaultStringType: g } = t.options, y = s && p || g;
    if (u = f(y), u === null)
...
function Xs(e, t) {
  if (t.tag) {
    const s = e.filter((r) => r.tag === t.tag);
    if (s.length > 0)
      return s.find((r) => r.format === t.format) ?? s[0];
  }
  let n, i;
  if (F(t)) {
    i = t.value;
    let s = e.filter((r) => r.identify?.(i));
    if (s.length > 1) {
      const r = s.filter((o) => o.test);
      r.length > 0 && (s = r);
    }
    n = s.find((r) => r.format === t.format) ?? s.find((r) => !r.format);
  } else
    i = t, n = e.find((s) => s.nodeClass && i instanceof s.nodeClass);
  if (!n) {
    const s = i?.constructor?.name ?? (i === null ? "null" : typeof i);
...
function Je(e, t, n, i) {
  ...
  let s;
  const r = q(e) ? e : t.doc.createNode(e, { onTagObj: (f) => s = f });
  s ?? (s = Xs(t.doc.schema.tags, r));
  const o = Zs(r, s, t);
  o.length > 0 && (t.indentAtStart = (t.indentAtStart ?? 0) + o.length + 1);
  const l = typeof s.stringify == "function" ? s.stringify(r, t, n, i) : F(r) ? ct(r, t, n, i) : r.toString(t, n, i);
  return o ? F(r) || l[0] === "{" || l[0] === "[" ? `${o} ${l}` : `${o}
${t.indent}${l}` : l;
}
function er({ key: e, value: t }, n, i, s) {
  ...
  let y = q(e) && e.comment || null;
  if (g) {
    if (y)
      throw new Error("With simple keys, key nodes cannot have comments");
    if (x(e) || !q(e) && typeof e == "object") {
      const N = "With simple keys, collection cannot be used as a key value";
      throw new Error(N);
    }
  }
  let m = !g && (!e || y && t == null && !n.inFlow || x(e) || (F(e) ? e.type === $.BLOCK_FOLDED || e.type === $.BLOCK_LITERAL : typeof e == "object"));
  n = Object.assign({}, n, {
    allNullValues: !1,
    implicitKey: !m && (g || !r),
    indent: l + f
  });
  let k = !1, b = !1, E = Je(e, n, () => k = !0, () => b = !0);
  if (!m && !n.inFlow && E.length > 1024) {
    if (g)
  ...
  if (n.inFlow) {
    if (r || t == null)
      return k && i && i(), E === "" ? "?" : m ? `? ${E}` : E;
  } else if (r && !g || t == null && m)
    return E = `? ${E}`, y && !k ? E += Ae(E, n.indent, u(y)) : b && s && s(), E;
  k && (y = null), m ? (y && (E += Ae(E, n.indent, u(y))), E = `? ${E}
${l}:`) : (E = `${E}:`, y && (E += Ae(E, n.indent, u(y))));
  let B, L, A;
  q(t) ? (B = !!t.spaceBefore, L = t.commentBefore, A = t.comment) : (B = !1, L = null, A = null, t && typeof t == "object" && (t = o.createNode(t))), n.implicitKey = !1, !m && !y && F(t) && (n.indentAtStart = E.length + 1), b = !1, !p && f.length >= 2 && !n.inFlow && !m && Ne(t) && !t.flow && !t.tag && !t.anchor && (n.indent = n.indent.substring(2));
  let _ = !1;
  const O = Je(t, n, () => _ = !0, () => b = !0);
  let T = " ";
  if (y || B || L) {
    if (T = B ? `
` : "", L) {
...
`), M = v !== -1, Q = n.inFlow ?? t.flow ?? t.items.length === 0;
    if (M || !Q) {
      let se = !1;
      if (M && (N === "&" || N === "!")) {
        let K = O.indexOf(" ");
        N === "&" && K !== -1 && K < v && O[K + 1] === "!" && (K = O.indexOf(" ", K + 1)), (K === -1 || v < K) && (se = !0);
      }
      se || (T = `
${n.indent}`);
    }
...
`) && (T = "");
  return E += T + O, n.inFlow ? _ && i && i() : A && !_ ? E += Ae(E, n.indent, u(A)) : b && s && s(), E;
}
function xi(e, t) {
...
const bt = "<<", ue = {
  ...
  stringify: () => bt
}, tr = (e, t) => (ue.identify(t) || F(t) && (!t.type || t.type === $.PLAIN) && ue.identify(t.value)) && e?.doc.schema.tags.some((n) => n.tag === ue.tag && n.default);
function qi(e, t, n) {
...
function nr(e, t, n) {
  ...
  if (q(e) && n?.doc) {
    ...
    if (!n.mapKeyWarned) {
      ...
      r.length > 40 && (r = r.substring(0, 36) + '..."'), xi(n.doc.options.logLevel, `Keys with collection values will be stringified due to JS Object restrictions: ${r}. Set mapAsMap: true to use object keys.`), n.mapKeyWarned = !0;
    }
    return s;
  }
...
class W {
  ...
  clone(t) {
    ...
    return q(n) && (n = n.clone(t)), q(i) && (i = i.clone(t)), new W(n, i);
  }
  toJSON(t, n) {
  ...
  toString(t, n, i) {
    return t?.doc ? er(this, t, n, i) : JSON.stringify(this);
  }
}
function Vi(e, t, n) {
...
function ir({ comment: e, items: t }, n, { blockItemPrefix: i, flowChars: s, itemIndent: r, onChompKeep: o, onComment: l }) {
  ...
  for (let k = 0; k < t.length; ++k) {
    ...
    let E = null;
    if (q(b))
      !g && b.spaceBefore && y.push(""), Pt(n, y, b.commentBefore, g), b.comment && (E = b.comment);
    else if (R(b)) {
      const L = q(b.key) ? b.key : null;
      L && (!g && L.spaceBefore && y.push(""), Pt(n, y, L.commentBefore, g));
    }
    g = !1;
    let B = Je(b, p, () => E = null, () => g = !0);
    E && (B += Ae(B, r, u(E))), g && E && (g = !1), y.push(i + B);
  }
  let m;
  if (y.length === 0)
    m = s.start + s.end;
...
function sr({ items: e }, t, { flowChars: n, itemIndent: i }) {
  ...
  for (let k = 0; k < e.length; ++k) {
    ...
    let E = null;
    if (q(b))
      b.spaceBefore && g.push(""), Pt(t, g, b.commentBefore, !1), b.comment && (E = b.comment);
    else if (R(b)) {
      const L = q(b.key) ? b.key : null;
      L && (L.spaceBefore && g.push(""), Pt(t, g, L.commentBefore, !1), L.comment && (u = !0));
      const A = q(b.value) ? b.value : null;
      A ? (A.comment && (E = A.comment), A.commentBefore && (u = !0)) : b.value == null && L?.comment && (E = L.comment);
    }
    E && (u = !0);
    let B = Je(b, f, () => E = null);
...
`)) && (u = !0), g.push(B), p = g.length;
  ...
  const { start: y, end: m } = n;
  if (g.length === 0)
    return y + m;
  if (!u) {
    const k = g.reduce((b, E) => b + E.length + 2, 2);
...
function Oe(e, t) {
  ...
  for (const i of e)
    if (R(i) && (i.key === t || i.key === n || F(i.key) && i.key.value === n))
      return i;
}
class X extends Mi {
  static get tagName() {
  ...
  add(t, n) {
    let i;
    R(t) ? i = t : !t || typeof t != "object" || !("key" in t) ? i = new W(t, t?.value) : i = new W(t.key, t.value);
    const s = Oe(this.items, i.key), r = this.schema?.sortMapEntries;
    if (s) {
      if (!n)
        throw new Error(`Key ${i.key} already set`);
      F(s.value) && Ui(i.value) ? s.value.value = i.value : s.value = i.value;
    } else if (r) {
      const o = this.items.findIndex((l) => r(i, l) < 0);
  ...
  get(t, n) {
    const s = Oe(this.items, t)?.value;
    return (!n && F(s) ? s.value : s) ?? void 0;
  }
  has(t) {
   ...
   */
  toJSON(t, n, i) {
    const s = i ? new i() : n?.mapAsMap ? /* @__PURE__ */ new Map() : {};
  ...
  toString(t, n, i) {
    ...
    return !t.allNullValues && this.hasAllNullValues(!1) && (t = Object.assign({}, t, { allNullValues: !0 })), Vi(this, t, {
      blockItemPrefix: "",
      flowChars: { start: "{", end: "}" },
      itemIndent: t.indent || "",
      onChompKeep: i,
...
class he extends Mi {
  ...
  set(t, n) {
    ...
    const s = this.items[i];
    F(s) && Ui(n) ? s.value = n : this.items[i] = n;
  }
  toJSON(t, n) {
    const i = [];
...
const Ce = {
  ...
  test: /^(?:~|[Nn]ull|NULL)?$/,
  resolve: () => new $(null),
  stringify: ({ source: e }, t) => typeof e == "string" && qt.test.test(e) ? e : t.options.nullStr
}, Bn = {
...
const Ji = {
  ...
  stringify: ie
}, Kt = (e) => typeof e == "bigint" || Number.isInteger(e), Ln = (e, t, n, { intAsBigInt: i }) => i ? BigInt(e) : parseInt(e.substring(t), n);
function Wi(e, t, n) {
  const { value: i } = e;
  return Kt(i) && i >= 0 ? n + i.toString(t) : ie(e);
}
const Ci = {
  identify: (e) => Kt(e) && e >= 0,
  default: !0,
...
class Ke extends he {
  constructor() {
    super(), this.add = X.prototype.add.bind(this), this.delete = X.prototype.delete.bind(this), this.get = X.prototype.get.bind(this), this.has = X.prototype.has.bind(this), this.set = X.prototype.set.bind(this), this.tag = Ke.tag;
  }
  /**
...
const $n = {
  ...
  resolve(e, t) {
    ...
    for (const { key: s } of n.items)
      F(s) && (i.includes(s.value) ? t(`Ordered maps must not include duplicate keys: ${s.value}`) : i.push(s.value));
...
function Vt(e, t, n, { intAsBigInt: i }) {
  const s = e[0];
...
const hr = {
  ...
  format: "HEX",
  test: /^[-+]?0x[0-9a-fA-F_]+$/,
  resolve: (e, t, n) => Vt(e, 2, 16, n),
  stringify: (e) => Pn(e, 16, "0x")
};
class Ve extends X {
  constructor(t) {
    super(t), this.tag = Ve.tag;
  }
  add(t) {
    let n;
  ...
  get(t, n) {
    ...
    return !n && R(i) ? F(i.key) ? i.key.value : i.key : i;
  }
  set(t, n) {
    if (typeof n != "boolean")
...
const is = {
  ...
  resolve: (e, t, { intAsBigInt: n }) => Fn(e, n),
  stringify: ns
}, ss = {
  identify: (e) => typeof e == "number",
  default: !0,
...
class ut {
  constructor({ compat: t, customTags: n, merge: i, resolveKnownTags: s, schema: r, sortMapEntries: o, toStringDefaults: l }) {
    this.compat = Array.isArray(t) ? rn(t, "compat") : t ? rn(null, t) : null, this.name = typeof r == "string" && r || "core", this.knownTags = s ? yr : {}, this.tags = rn(n, this.name, i), this.toStringOptions = l ?? null, Object.defineProperty(this, be, { value: We }), Object.defineProperty(this, ae, { value: xt }), Object.defineProperty(this, Ge, { value: Ce }), this.sortMapEntries = typeof o == "function" ? o : o === !0 ? mr : null;
  }
  clone() {
...
function br(e, t) {
  ...
  if (e.contents) {
    if (q(e.contents)) {
      if (e.contents.spaceBefore && i && n.push(""), e.contents.commentBefore) {
        const p = r(e.contents.commentBefore);
        n.push(fe(p, ""));
      }
      s.forceBlockIndent = !!e.comment, l = e.contents.comment;
    }
    const f = l ? void 0 : () => o = !0;
    let u = Je(e.contents, s, () => l = null, f);
    l && (u += Ae(u, "", r(l))), (u[0] === "|" || u[0] === ">") && n[n.length - 1] === "---" ? n[n.length - 1] = `--- ${u}` : n.push(u);
  } else
  ...
  if (e.directives?.docEnd)
    if (e.comment) {
      const f = r(e.comment);
      f.includes(`
`) ? (n.push("..."), n.push(fe(f, ""))) : n.push(`... ${f}`);
    } else
      n.push("...");
  else {
    let f = e.comment;
    f && o && (f = f.replace(/^\n+/, "")), f && ((!o || l) && n[n.length - 1] !== "" && n.push(""), n.push(fe(r(f), "")));
  }
  return n.join(`
`) + `
`;
...
class Be {
  constructor(t, n, i) {
    ...
    this.options = r;
    let { version: o } = r;
    i?._directives ? (this.directives = i._directives.atDocument(), this.directives.yaml.explicit && (o = this.directives.yaml.version)) : this.directives = new C({ version: o }), this.setSchema(o, i), this.contents = t === void 0 ? null : this.createNode(t, s, i);
  }
  /**
  ...
  createNode(t, n, i) {
    ...
    if (typeof n == "function")
      ...
      const E = (L) => typeof L == "number" || L instanceof String || L instanceof Number, B = n.filter(E).map(String);
      B.length > 0 && (n = n.concat(B)), s = n;
    } else i === void 0 && n && (i = n, n = void 0);
    const { aliasDuplicateObjects: r, anchorPrefix: o, flow: l, keepUndefined: f, onTagObj: u, tag: p } = i ?? {}, { onAnchor: g, setAnchors: y, sourceObjects: m } = Gs(
      this,
   ...
   */
  get(t, n) {
    return x(this.contents) ? this.contents.get(t, n) : void 0;
  }
  /**
   ...
   */
  getIn(t, n) {
    return et(t) ? !n && F(this.contents) ? this.contents.value : this.contents : x(this.contents) ? this.contents.getIn(t, n) : void 0;
  }
  /**
   * Checks if the document includes a value with the key `key`.
   */
  has(t) {
    return x(this.contents) ? this.contents.has(t) : !1;
  }
  /**
   * Checks if the document includes a value at `path`.
   */
  hasIn(t) {
    return et(t) ? this.contents !== void 0 : x(this.contents) ? this.contents.hasIn(t) : !1;
  }
  /**
  ...
  setSchema(t, n = {}) {
    ...
    switch (t) {
      case "1.1":
        this.directives ? this.directives.yaml.version = "1.1" : this.directives = new C({ version: "1.1" }), i = { resolveKnownTags: !1, schema: "yaml-1.1" };
        break;
      case "1.2":
      case "next":
        this.directives ? this.directives.yaml.version = t : this.directives = new C({ version: t }), i = { resolveKnownTags: !0, schema: "core" };
        break;
      case null:
  ...
  toJS({ json: t, jsonArg: n, mapAsMap: i, maxAliasCount: s, onAnchor: r, reviver: o } = {}) {
    ...
    if (typeof r == "function")
      for (const { count: u, res: p } of l.anchors.values())
        r(p, u);
    return typeof o == "function" ? xe(o, { "": f }, "", f) : f;
  }
  /**
...
function Ye(e, { flow: t, indicator: n, next: i, offset: s, onError: r, parentIndent: o, startOnNewline: l }) {
  let f = !1, u = l, p = l, g = "", y = "", m = !1, k = !1, b = null, E = null, B = null, L = null, A = null, _ = null, O = null;
  for (const v of e)
    switch (k && (v.type !== "space" && v.type !== "newline" && v.type !== "comma" && r(v.offset, "MISSING_CHAR", "Tags and anchors must be separated from the next token by white space"), k = !1), b && (u && v.type !== "comment" && v.type !== "newline" && r(b, "TAB_AS_INDENT", "Tabs are not allowed as indentation"), b = null), v.type) {
      case "space":
        !t && (n !== "doc-start" || i?.type !== "flow-collection") && v.source.includes("	") && (b = v), p = !0;
        break;
      case "comment": {
      ...
      case "newline":
        u ? g ? g += v.source : (!_ || n !== "seq-item-ind") && (f = !0) : y += v.source, u = !0, m = !0, (E || B) && (L = v), p = !0;
        break;
      case "anchor":
      ...
      case n:
        (E || B) && r(v, "BAD_PROP_ORDER", `Anchors and tags must be after the ${v.source} indicator`), _ && r(v, "UNEXPECTED_TOKEN", `Unexpected ${v.source} in ${t ?? "collection"}`), _ = v, u = n === "seq-item-ind" || n === "explicit-key-ind", p = !1;
        break;
      case "comma":
        if (t) {
  ...
  return k && i && i.type !== "space" && i.type !== "newline" && i.type !== "comma" && (i.type !== "scalar" || i.source !== "") && r(i.offset, "MISSING_CHAR", "Tags and anchors must be separated from the next token by white space"), b && (u && b.indent <= o || i?.type === "block-map" || i?.type === "block-seq") && r(b, "TAB_AS_INDENT", "Tabs are not allowed as indentation"), {
    comma: A,
    found: _,
    spaceBefore: f,
    comment: g,
...
function rs(e, t, n) {
  ...
  if (i === !1)
    return !1;
  const s = typeof i == "function" ? i : (r, o) => r === o || F(r) && F(o) && r.value === o.value;
...
function wr({ composeNode: e, composeEmptyNode: t }, n, i, s, r) {
  const o = r?.nodeClass ?? X, l = new o(n.schema);
  n.atRoot && (n.atRoot = !1);
  let f = i.offset, u = null;
  for (const p of i.items) {
    const { start: g, key: y, sep: m, value: k } = p, b = Ye(g, {
    ...
    if (E) {
      if (y && (y.type === "block-seq" ? s(f, "BLOCK_AS_IMPLICIT_KEY", "A block sequence may not be used as an implicit map key") : "indent" in y && y.indent !== i.indent && s(f, "BAD_INDENT", ri)), !b.anchor && !b.tag && !m) {
        u = b.end, b.comment && (l.comment ? l.comment += `
` + b.comment : l.comment = b.comment);
        continue;
      }
      (b.newlineAfterProp || it(y)) && s(y ?? g[g.length - 1], "MULTILINE_IMPLICIT_KEY", "Implicit keys need to be on a single line");
    } else b.found?.indent !== i.indent && s(f, "BAD_INDENT", ri);
    n.atKey = !0;
    const B = b.end, L = y ? e(n, y, b, s) : t(n, B, g, null, b, s);
    n.schema.compat && mn(i.indent, y, s), n.atKey = !1, rs(n, l.items, L) && s(B, "DUPLICATE_KEY", "Map keys must be unique");
    const A = Ye(m ?? [], {
    ...
    if (f = A.end, A.found) {
      E && (k?.type === "block-map" && !A.hasNewline && s(f, "BLOCK_AS_IMPLICIT_KEY", "Nested mappings are not allowed in compact mappings"), n.options.strict && b.start < A.found.offset - 1024 && s(L.range, "KEY_OVER_1024_CHARS", "The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));
      const _ = k ? e(n, k, A, s) : t(n, f, m, null, A, s);
      n.schema.compat && mn(i.indent, k, s), f = _.range[2];
      const O = new W(L, _);
      n.options.keepSourceTokens && (O.srcToken = p), l.items.push(O);
    } else {
      E && s(L.range, "MISSING_CHAR", "Implicit map keys need to be followed by map values"), A.comment && (L.comment ? L.comment += `
` + A.comment : L.comment = A.comment);
      const _ = new W(L);
      n.options.keepSourceTokens && (_.srcToken = p), l.items.push(_);
    }
  }
...
function kr({ composeNode: e, composeEmptyNode: t }, n, i, s, r) {
  const o = r?.nodeClass ?? he, l = new o(n.schema);
  ...
  for (const { start: p, value: g } of i.items) {
    ...
    if (!y.found)
      if (y.anchor || y.tag || g)
        g && g.type === "block-seq" ? s(y.end, "BAD_INDENT", "All sequence items must start at the same column") : s(f, "MISSING_CHAR", "Sequence item without - indicator");
      else {
        u = y.end, y.comment && (l.comment = y.comment);
        continue;
      }
    const m = g ? e(n, g, y, s) : t(n, y.end, p, null, y, s);
    n.schema.compat && mn(i.indent, g, s), f = m.range[2], l.items.push(m);
  }
...
function Er({ composeNode: e, composeEmptyNode: t }, n, i, s, r) {
  const o = i.start.source === "{", l = o ? "flow map" : "flow sequence", f = r?.nodeClass ?? (o ? X : he), u = new f(n.schema);
  u.flow = !0;
  const p = n.atRoot;
  p && (n.atRoot = !1), n.atKey && (n.atKey = !1);
  let g = i.offset + i.start.source.length;
  for (let E = 0; E < i.items.length; ++E) {
    const B = i.items[E], { start: L, key: A, sep: _, value: O } = B, T = Ye(L, {
      flow: l,
      indicator: "explicit-key-ind",
      next: A ?? _?.[0],
      offset: g,
...
` + N : v.comment = N, T.comment = T.comment.substring(N.length + 1);
    ...
    if (!o && !_ && !T.found) {
      const N = O ? e(n, O, T, s) : t(n, T.end, _, null, T, s);
      u.items.push(N), g = N.range[2], ln(O) && s(N.range, "BLOCK_IN_FLOW", on);
    } else {
      n.atKey = !0;
      const N = T.end, v = A ? e(n, A, T, s) : t(n, N, L, null, T, s);
          ...
          if (_)
            for (const K of _) {
              if (K === M.found)
                break;
              if (K.type === "newline") {
                s(K, "MULTILINE_IMPLICIT_KEY", "Implicit keys of flow sequence pairs need to be on a single line");
                break;
              }
            }
      ...
      const Q = O ? e(n, O, M, s) : M.found ? t(n, M.end, _, null, M, s) : null;
      Q ? ln(O) && s(Q.range, "BLOCK_IN_FLOW", on) : M.comment && (v.comment ? v.comment += `
` + M.comment : v.comment = M.comment);
      const se = new W(v, Q);
      if (n.options.keepSourceTokens && (se.srcToken = B), o) {
        const K = u;
        rs(n, K.items, v) && s(N, "DUPLICATE_KEY", "Map keys must be unique"), K.items.push(se);
      } else {
        const K = new X(n.schema);
        K.flow = !0, K.items.push(se);
        const de = (Q ?? v).range;
        K.range = [v.range[0], de[1], de[2]], u.items.push(K);
      }
      g = Q ? Q.range[2] : M.end;
    }
  }
  ...
  let b = g;
  if (m && m.source === y)
    b = m.offset + m.source.length;
  else {
    const E = l[0].toUpperCase() + l.substring(1), B = p ? `${E} must end with a ${y}` : `${E} in block collection must be sufficiently indented and end with a ${y}`;
    s(g, p ? "MISSING_CHAR" : "BAD_INDENT", B), m && m.source.length !== 1 && k.unshift(m);
  }
  if (k.length > 0) {
    const E = ht(k, b, n.options.strict, s);
    E.comment && (u.comment ? u.comment += `
` + E.comment : u.comment = E.comment), u.range = [i.offset, b, E.offset];
  } else
    u.range = [i.offset, b, b];
  return u;
}
...
function Sr(e, t, n, i, s) {
  ...
  if (n.type === "block-seq") {
    const { anchor: y, newlineAfterProp: m } = i, k = y && r ? y.offset > r.offset ? y : r : y ?? r;
    k && (!m || m.offset < k.offset) && s(k, "MISSING_CHAR", "Missing newline after block sequence props");
  }
  ...
  const u = an(e, t, n, s, o, f), p = f.resolve?.(u, (y) => s(r, "TAG_RESOLVE_FAILED", y), t.options) ?? u, g = q(p) ? p : new $(p);
  return g.range = u.range, g.tag = o, f?.format && (g.format = f.format), g;
}
function os(e, t, n) {
  ...
  if (l === 0) {
    const b = s.chomp === "+" && o.length > 0 ? `
`.repeat(Math.max(1, o.length - 1)) : "";
    let E = i + s.length;
    return t.source && (E += t.source.length), { value: b, type: r, comment: s.comment, range: [i, E, E] };
  }
  ...
  for (let b = 0; b < l; ++b) {
    ...
    if (B === "" || B === "\r")
      ...
      E.length < f && n(u + E.length, "MISSING_CHAR", "Block scalars with more-indented leading empty lines must use an explicit indentation indicator"), s.indent === 0 && (f = E.length), p = b, f === 0 && !e.atRoot && n(u, "BAD_INDENT", "Block scalar values in collections must be indented");
      break;
    }
    u += E.length + B.length + 1;
  }
  for (let b = o.length - 1; b >= l; --b)
    o[b][0].length > f && (l = b + 1);
  let g = "", y = "", m = !1;
  for (let b = 0; b < p; ++b)
    g += o[b][0].slice(f) + `
`;
  for (let b = p; b < l; ++b) {
    let [E, B] = o[b];
    u += E.length + B.length + 1;
    const L = B[B.length - 1] === "\r";
    if (L && (B = B.slice(0, -1)), B && E.length < f) {
      const _ = `Block scalar lines must not be less indented than their ${s.indent ? "explicit indentation indicator" : "first line"}`;
      n(u - B.length - (L ? 2 : 1), "BAD_INDENT", _), E = "";
    }
    r === $.BLOCK_LITERAL ? (g += y + E.slice(f) + B, y = `
`) : E.length > f || B[0] === "	" ? (y === " " ? y = `
` : !m && y === `
` && (y = `
  ...
  for (let y = 1; y < t.length; ++y) {
    ...
    switch (m.type) {
      ...
      case "newline":
        ...
        break;
      case "comment":
        n && !u && i(m, "MISSING_CHAR", "Comments must be separated from other tokens by white space characters"), g += m.source.length, p = m.source.substring(1);
        break;
      case "error":
        i(m, "UNEXPECTED_TOKEN", m.message), g += m.source.length;
        break;
      /* istanbul ignore next should not happen */
      default: {
        const k = `Unexpected token in block scalar header: ${m.type}`;
        i(m, "UNEXPECTED_TOKEN", k);
        const b = m.source;
...
function Or(e) {
  const t = e.split(/\n( *)/), n = t[0], i = n.match(/^( *)/), r = [i?.[1] ? [i[1], n.slice(i[1].length)] : ["", n]];
...
` : (s += r + i[1], r = " "), o = n.lastIndex;
  const l = /[ \t]*(.*)/sy;
  return l.lastIndex = o, i = l.exec(e), s + r + (i?.[1] ?? "");
}
function Nr(e, t) {
  let n = "";
...
function cs(e, t, n, i) {
  ...
  let p;
  try {
    const g = u.resolve(s, (y) => i(n ?? t, "TAG_RESOLVE_FAILED", y), e.options);
    p = F(g) ? g : new $(g);
  } catch (g) {
    const y = g instanceof Error ? g.message : String(g);
    i(n ?? t, "TAG_RESOLVE_FAILED", y), p = new $(s);
  }
...
function $r({ atKey: e, directives: t, schema: n }, i, s, r) {
  const o = n.tags.find((l) => (l.default === !0 || e && l.default === "key") && l.test?.test(i)) || n[ae];
  if (n.compat) {
    const l = n.compat.find((f) => f.default && f.test?.test(i)) ?? n[ae];
    if (o.tag !== l.tag) {
...
const jr = { composeNode: fs, composeEmptyNode: Mn };
function fs(e, t, n, i) {
  const s = e.atKey, { spaceBefore: r, comment: o, anchor: l, tag: f } = n;
  let u, p = !0;
  switch (t.type) {
    case "alias":
      u = Fr(e, t, i), (l || f) && i(t, "ALIAS_PROPS", "An alias node must not specify any properties");
      break;
    case "scalar":
    case "single-quoted-scalar":
    case "double-quoted-scalar":
    ...
    case "block-seq":
    case "flow-collection":
      u = Sr(jr, e, t, n, i), l && (u.anchor = l.source.substring(1));
      break;
    default: {
  ...
  return l && u.anchor === "" && i(l, "BAD_ALIAS", "Anchor cannot be an empty string"), s && e.options.stringKeys && (!F(u) || typeof u.value != "string" || u.tag && u.tag !== "tag:yaml.org,2002:str") && i(f ?? t, "NON_STRING_KEY", "With stringKeys, all keys must be strings"), r && (u.spaceBefore = !0), o && (t.type === "scalar" && t.source === "" ? u.comment = o : u.commentBefore = o), e.options.keepSourceTokens && p && (u.srcToken = t), u;
}
...
function Fr({ options: e }, { offset: t, source: n, end: i }, s) {
...
function Ur(e, t, { offset: n, start: i, value: s, end: r }, o) {
  ...
  const g = f.contents.range[2], y = ht(r, g, !1, o);
  return y.comment && (f.comment = y.comment), f.range = [n, g, y.offset], f;
}
function ze(e) {
  if (typeof e == "number")
    return [e, e + 1];
...
class Gt {
  constructor(t = {}) {
    ...
    }, this.directives = new C({ version: t.version || "1.2" }), this.options = t;
  }
  decorate(t, n) {
...
`, y = [
      ...
      return us(y, f) || y.push({ type: "newline", offset: -1, indent: i, source: `
` }), { type: "block-scalar", offset: r, indent: i, props: y, source: g };
    }
    case '"':
...
const qr = (e) => "type" in e ? Ft(e) : vt(e);
function Ft(e) {
  switch (e.type) {
    case "block-scalar": {
      let t = "";
...
const bn = /* @__PURE__ */ Symbol("break visit"), Kr = /* @__PURE__ */ Symbol("skip children"), hs = /* @__PURE__ */ Symbol("remove item");
function Ie(e, t) {
...
Ie.parentCollection = (e, t) => {
  const n = Ie.itemAtPath(e, t.slice(0, -1)), i = t[t.length - 1][0], s = n?.[i];
  if (s && "items" in s)
    return s;
...
const Wt = "\uFEFF", Ct = "", Qt = "", st = "", Vr = (e) => !!e && "items" in e, Jr = (e) => !!e && (e.type === "scalar" || e.type === "single-quoted-scalar" || e.type === "double-quoted-scalar" || e.type === "block-scalar");
function Yr(e) {
  switch (e) {
    case Wt:
      return "<BOM>";
...
`, this.pos), this.lineEndPos = t), t === -1 ? this.atEnd ? this.buffer.substring(this.pos) : null : (this.buffer[t - 1] === "\r" && (t -= 1), this.buffer.substring(this.pos, t));
  ...
  *parseStream() {
    ...
    return yield Ct, yield* this.parseLineStart();
  }
  *parseLineStart() {
  ...
  *parseFlowCollection() {
    ...
    if ((i !== -1 && i < this.indentNext && s[0] !== "#" || i === 0 && (s.startsWith("---") || s.startsWith("...")) && ne(s[3])) && !(i === this.indentNext - 1 && this.flowLevel === 1 && (s[0] === "]" || s[0] === "}")))
      return this.flowLevel = 0, yield Qt, yield* this.parseLineStart();
    let r = 0;
    for (; s[r] === ","; )
  ...
  *blockMap(t) {
    ...
    if (this.indent >= t.indent) {
      ...
      switch (this.type) {
        case "anchor":
        case "tag":
          s || n.value ? (r.push(this.sourceToken), t.items.push({ start: r }), this.onKeyLine = !0) : n.sep ? n.sep.push(this.sourceToken) : n.start.push(this.sourceToken);
          return;
        case "explicit-key-ind":
          !n.sep && !n.explicitKey ? (n.start.push(this.sourceToken), n.explicitKey = !0) : s || n.value ? (r.push(this.sourceToken), t.items.push({ start: r, explicitKey: !0 })) : this.stack.push({
            type: "block-map",
            offset: this.offset,
            indent: this.indent,
          ...
          if (n.explicitKey)
            if (n.sep)
              if (n.value)
                ...
                const o = Pe(n.start), l = n.key, f = n.sep;
            ...
            n.sep ? n.value || s ? t.items.push({ start: r, key: null, sep: [this.sourceToken] }) : ye(n.sep, "map-value-ind") ? this.stack.push({
              type: "block-map",
              offset: this.offset,
              indent: this.indent,
        ...
        case "double-quoted-scalar": {
          ...
          s || n.value ? (t.items.push({ start: r, key: o, sep: [] }), this.onKeyLine = !0) : n.sep ? this.stack.push(o) : (Object.assign(n, { key: o, sep: [] }), this.onKeyLine = !0);
          return;
        }
        default: {
...
function bs(e, t = {}) {
  const { lineCounter: n, prettyErrors: i } = ms(t), s = new Ht(n?.addNewLine), r = new Gt(t), o = Array.from(r.compose(s.parse(e)));
  if (i && n)
    for (const l of o)
      l.errors.forEach(jt(e, n)), l.warnings.forEach(jt(e, n));
  return o.length > 0 ? o : Object.assign([], { empty: !0 }, r.streamInfo());
}
function xn(e, t = {}) {
  const { lineCounter: n, prettyErrors: i } = ms(t), s = new Ht(n?.addNewLine), r = new Gt(t);
  let o = null;
  ...
  return i && n && (o.errors.forEach(jt(e, n)), o.warnings.forEach(jt(e, n))), o;
}
function ws(e, t, n) {
  let i;
  ...
  if (!s)
    return null;
  if (s.warnings.forEach((r) => xi(s.options.logLevel, r)), s.errors.length > 0) {
...
const Cr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  visit: ke,
  visitAsync: lt
}, Symbol.toStringTag, { value: "Module" })), qn = /* @__PURE__ */ Oi(Qr);
var fi;
function Hr() {
  if (fi) return mt;
  ...
  function t(r, o, l, f, u) {
    ...
    if ((0, e.isMap)(f)) {
      ...
      u.onArrayStart(o, l, f, p), f.items.forEach((g, y) => {
        t(r, f, y, g, u);
      }), u.onArrayEnd();
...
function zt(e, t = !1) {
  ...
  function k() {
    ...
    if (e.charCodeAt(i) === 48)
      ...
      for (i++; i < e.length && je(e.charCodeAt(i)); )
        i++;
    if (i < e.length && e.charCodeAt(i) === 46)
      if (i++, i < e.length && je(e.charCodeAt(i)))
        for (i++; i < e.length && je(e.charCodeAt(i)); )
          i++;
      else
    ...
    if (i < e.length && (e.charCodeAt(i) === 69 || e.charCodeAt(i) === 101))
      if (i++, (i < e.length && e.charCodeAt(i) === 43 || e.charCodeAt(i) === 45) && i++, i < e.length && je(e.charCodeAt(i))) {
        for (i++; i < e.length && je(e.charCodeAt(i)); )
          i++;
        _ = i;
      } else
    ...
    switch (A) {
      ...
      case 47:
        ...
        if (e.charCodeAt(i + 1) === 42) {
          ...
          return T || (i++, g = 1), s = e.substring(_, i), o = 13;
        }
        return s += String.fromCharCode(A), i++, o = 16;
      // numbers
      case 45:
        if (s += String.fromCharCode(A), i++, i === n || !je(e.charCodeAt(i)))
          return o = 16;
...
const Z = new Array(20).fill(0).map((e, t) => " ".repeat(t)), Fe = 200, pi = {
  " ": {
    "\n": new Array(Fe).fill(0).map((e, t) => `
` + " ".repeat(t)),
    "\r": new Array(Fe).fill(0).map((e, t) => "\r" + " ".repeat(t)),
    "\r\n": new Array(Fe).fill(0).map((e, t) => `\r
` + " ".repeat(t))
  },
  "	": {
    "\n": new Array(Fe).fill(0).map((e, t) => `
...
function Es(e, t, n) {
  ...
  let p = 0, g = 0, y;
  n.insertSpaces ? y = Z[n.tabSize || 4] ?? Ue(Z[1], n.tabSize || 4) : y = "	";
  const m = y === "	" ? "	" : " ";
  let k = zt(s, !1), b = !1;
  function E() {
    if (p > 1)
      return Ue(f, p) + Ue(y, i + g);
    const O = y.length * (i + g);
    return !u || O > pi[m][f].length ? f + Ue(y, i + g) : O <= 0 ? f : pi[m][f][O];
  }
  function B() {
    let O = k.scan();
    for (p = 0; O === 15 || O === 14; )
      O === 14 && n.keepLines ? p += 1 : O === 14 && (p = 1), O = k.scan();
    return b = O === 16 || k.getTokenError() !== 0, O;
  }
  const L = [];
  function A(O, T, N) {
    !b && (!t || T < l && N > o) && e.substring(T, N) !== O && L.push({ offset: T, length: N - T, content: O });
  }
  let _ = B();
  if (n.keepLines && p > 0 && A(Ue(f, p), 0, 0), _ !== 17) {
    let O = k.getTokenOffset() + r, T = y.length * i < 20 && n.insertSpaces ? Z[y.length * i] : Ue(y, i);
    A(T, r, O);
  }
  for (; _ !== 17; ) {
    let O = k.getTokenOffset() + k.getTokenLength() + r, T = B(), N = "", v = !1;
    for (; p === 0 && (T === 12 || T === 13); ) {
      let Q = k.getTokenOffset() + r;
      A(Z[1], O, Q), O = k.getTokenOffset() + k.getTokenLength() + r, v = T === 12, N = v ? E() : "", T = B();
    }
    if (T === 2)
      _ !== 1 && g--, n.keepLines && p > 0 || !n.keepLines && _ !== 1 ? N = E() : n.keepLines && (N = Z[1]);
    else if (T === 4)
      _ !== 3 && g--, n.keepLines && p > 0 || !n.keepLines && _ !== 3 ? N = E() : n.keepLines && (N = Z[1]);
    else {
      switch (_) {
        case 3:
        case 1:
        ...
        case 2:
        case 4:
          n.keepLines && p > 0 ? N = E() : (T === 12 || T === 13) && !v ? N = Z[1] : T !== 5 && T !== 17 && (b = !0);
          break;
        case 16:
          b = !0;
          break;
...
function Xt(e, t, n = rt.DEFAULT) {
  ...
  let r = 0;
  function o(j) {
    return j ? () => r === 0 && j(i.getTokenOffset(), i.getTokenLength(), i.getTokenStartLine(), i.getTokenStartCharacter()) : () => !0;
  }
  function l(j) {
    return j ? (V) => r === 0 && j(V, i.getTokenOffset(), i.getTokenLength(), i.getTokenStartLine(), i.getTokenStartCharacter()) : () => !0;
  }
  function f(j) {
    return j ? (V) => r === 0 && j(V, i.getTokenOffset(), i.getTokenLength(), i.getTokenStartLine(), i.getTokenStartCharacter(), () => s.slice()) : () => !0;
  }
  function u(j) {
    return j ? () => {
      r > 0 ? r++ : j(i.getTokenOffset(), i.getTokenLength(), i.getTokenStartLine(), i.getTokenStartCharacter(), () => s.slice()) === !1 && (r = 1);
    } : () => !0;
  }
  function p(j) {
    return j ? () => {
      r > 0 && r--, r === 0 && j(i.getTokenOffset(), i.getTokenLength(), i.getTokenStartLine(), i.getTokenStartCharacter());
    } : () => !0;
  }
  const g = u(t.onObjectBegin), y = f(t.onObjectProperty), m = p(t.onObjectEnd), k = u(t.onArrayBegin), b = p(t.onArrayEnd), E = f(t.onLiteralValue), B = l(t.onSeparator), L = o(t.onComment), A = l(t.onError), _ = n && n.disallowComments, O = n && n.allowTrailingComma;
  function T() {
    for (; ; ) {
      const j = i.scan();
  ...
  function v(j) {
    const V = i.getTokenValue();
    return j ? E(V) : (y(V), s.push(V)), T(), !0;
  }
  function M() {
    switch (i.getToken()) {
      case 11:
        const j = i.getTokenValue();
        let V = Number(j);
        isNaN(V) && (N(
          2
  ...
  function K() {
    ...
    for (; i.getToken() !== 4 && i.getToken() !== 17; ) {
      if (i.getToken() === 5) {
        if (V || N(4, [], []), B(","), T(), i.getToken() === 4 && O)
          break;
      } else V && N(6, [], []);
      j ? (s.push(0), j = !1) : s[s.length - 1]++, de() || N(4, [], [
        4,
        5
        /* SyntaxKind.CommaToken */
      ]), V = !0;
    }
    return b(), j || s.pop(), i.getToken() !== 4 ? N(8, [
      4
    ...
    if (l.type === "object" && typeof f == "string" && Array.isArray(l.children)) {
      ...
      if (u !== void 0)
        if (n === void 0) {
          ...
          let g, y = u.parent.offset + u.parent.length;
          if (p > 0) {
            let m = l.children[p - 1];
            g = m.offset + m.length;
          } else
            g = l.offset + 1, l.children.length > 1 && (y = l.children[1].offset);
          return Ee(e, { offset: g, length: y - g, content: "" }, i);
        } else
          return Ee(e, { offset: u.offset, length: u.length, content: JSON.stringify(n) }, i);
      else {
        if (n === void 0)
          return [];
        const p = `${JSON.stringify(f)}: ${JSON.stringify(n)}`, g = i.getInsertionIndex ? i.getInsertionIndex(l.children.map((m) => m.children[0].value)) : l.children.length;
        let y;
        if (g > 0) {
          let m = l.children[g - 1];
          y = { offset: m.offset + m.length, length: 0, content: "," + p };
        } else l.children.length === 0 ? y = { offset: l.offset + 1, length: 0, content: p } : y = { offset: l.offset + 1, length: 0, content: p + "," };
        return Ee(e, y, i);
      }
      ...
      if (u === -1) {
        ...
        if (l.children.length === 0)
          ...
          g = { offset: y.offset + y.length, length: 0, content: "," + p };
        }
        return Ee(e, g, i);
        ...
        if (l.children.length === 1)
          ...
          let m = l.children[p - 1], k = m.offset + m.length, b = l.offset + l.length;
          y = { offset: k, length: b - 2 - k, content: "" };
        } else
          y = { offset: g.offset, length: l.children[p + 1].offset - g.offset, content: "" };
        return Ee(e, y, i);
      } else if (n !== void 0) {
        let p;
        ...
        if (!i.isArrayInsertion && l.children.length > f) {
          ...
          p = { offset: y.offset, length: y.length, content: g };
        } else if (l.children.length === 0 || f === 0)
          p = { offset: l.offset + 1, length: 0, content: l.children.length === 0 ? g : g + "," };
        else {
          const y = f > l.children.length ? l.children.length : f, m = l.children[y - 1];
          p = { offset: m.offset + m.length, length: 0, content: "," + g };
        }
        return Ee(e, p, i);
      } else
...
function So() {
  ...
  function s(r, o = [], l = t.DEFAULT) {
    ...
    function u(m) {
      f.type === "property" && (f.length = m - f.offset, f = f.parent);
    }
    function p(m) {
    ...
    const g = {
      ...
      onObjectEnd: (m, k) => {
        if (u(m + k), f.type === "object" && f.children && f.children.length > 1) {
          const b = i(f.children);
          for (const { offset: E, length: B } of b)
            o.push({
              error: 0,
              extendedError: 1,
              offset: E,
        ...
        f.length = m + k - f.offset, f = f.parent, u(m + k);
      },
      onArrayBegin: (m, k) => {
        f = p({
          type: "array",
      ...
      onLiteralValue: (m, k, b) => {
        p({
          ...
          parent: f,
          value: m,
          rawValue: r.substring(k, k + b)
        }), u(k + b);
      },
      onSeparator: (m, k, b) => {
        f.type === "property" && (m === ":" ? f.colonOffset = k : m === "," && u(k));
      },
      onError: (m, k, b) => {
        o.push({ error: m, offset: k, length: b });
      }
    };
    (0, e.visit)(r, g, l);
    const y = f.children[0];
    return y && delete y.parent, y;
  }
  return Ot;
}
var It = {}, gi;
...
function Oo() {
  ...
  function f(g) {
    ...
    return m ? [p(t.visitJson, void 0, m), k] : [void 0, k];
  }
  function u(g, y) {
    const m = r.parseAllDocuments(g, {
      customTags: (0, o.getCustomTags)(y || {})
    });
    if (m.length !== 1)
      return [void 0, []];
    const k = m[0], b = k.errors.map((B) => ({
      message: B.message,
      offset: B.pos[0],
    ...
    return r.visit(k, {
      Alias(B, L) {
        L.resolve(k) || b.push({
          ...
          offset: L.range[0],
          length: L.range[1] - L.range[0]
        });
      }
    }), [p(e.visitYaml, k, k.contents), b];
  }
  function p(g, y, m) {
    var k;
    let b = {};
    const E = [b];
    if (g(y, null, "fakeroot", m, {
      onObjectStart: (L, A, _, O) => {
        O && (0, n.setPreservedLocation)(b, A, O), E.push(b), b = b[A] = {};
      },
      onObjectEnd: () => {
        b = E.pop();
      },
      onArrayStart: (L, A, _, O) => {
        O && (0, n.setPreservedLocation)(b, A, O), E.push(b), b = b[A] = [];
      },
      onArrayEnd: () => {
        b = E.pop();
      ...
      onValue: (L, A, _, O, T) => {
        b[A] = _, typeof _ == "number" && O !== void 0 && (0, n.setPreservedValue)(b, A, O), T && (0, n.setPreservedLocation)(b, A, T);
      }
...
function Io() {
  ...
  function n(l) {
    ...
    return (0, e.visitObject)(void 0, "fakeroot", l, {
      ...
      onValue: (u, p, g, y) => {
        y !== void 0 ? f.push(r(p, y) + ",") : f.push(r(p, JSON.stringify(g)) + ",");
      }
...
`));
      ...
      onValue: (y, m, k, b) => {
        g[g.length - 1] = !1, b !== void 0 ? u.push(o(f, p) + r(m, b, !1) + `,
`) : u.push(o(f, p) + r(m, JSON.stringify(k), !1) + `,
`);
      }
...
function Ns() {
  ...
  function s(l) {
    ...
    function p(y) {
      ...
      throw new Error("Invalid tilde escape: " + y);
    }
    function g(y) {
      return f.test(y) ? y.replace(u, p) : y;
    }
...
function To() {
  ...
  function s(l, f, u, p) {
    ...
    for (const y of g) {
      const m = (0, e.getPreservedLocation)(l, y);
      if (m && n(m.value, f)) {
        const k = l[y];
        return u.push(y), k !== null && typeof k == "object" ? s(k, f, u, m) : [k, u, m];
      }
    }
    return [l, u, p];
  }
...
function No() {
  return ki || (ki = 1, (function(e) {
    ...
    function l(f, u, p) {
      var g;
      return u === "yaml" ? (0, n.parseYaml)(f, (g = p?.yaml) === null || g === void 0 ? void 0 : g.customTags) : (0, n.parseJson)(f);
    }
  })(nn)), nn;
}
var Ro = No(), hn = {}, Ze = {}, Ei;
function Bo() {
  if (Ei) return Ze;
  Ei = 1, Ze.byteLength = l, Ze.toByteArray = u, Ze.fromByteArray = y;
  ...
  function u(m) {
    var k, b = o(m), E = b[0], B = b[1], L = new n(f(m, E, B)), A = 0, _ = B > 0 ? E - 4 : E, O;
    for (O = 0; O < _; O += 4)
      k = t[m.charCodeAt(O)] << 18 | t[m.charCodeAt(O + 1)] << 12 | t[m.charCodeAt(O + 2)] << 6 | t[m.charCodeAt(O + 3)], L[A++] = k >> 16 & 255, L[A++] = k >> 8 & 255, L[A++] = k & 255;
    return B === 2 && (k = t[m.charCodeAt(O)] << 2 | t[m.charCodeAt(O + 1)] >> 4, L[A++] = k & 255), B === 1 && (k = t[m.charCodeAt(O)] << 10 | t[m.charCodeAt(O + 1)] << 4 | t[m.charCodeAt(O + 2)] >> 2, L[A++] = k >> 8 & 255, L[A++] = k & 255), L;
  }
  function p(m) {
    return e[m >> 18 & 63] + e[m >> 12 & 63] + e[m >> 6 & 63] + e[m & 63];
  }
  function g(m, k, b) {
    for (var E, B = [], L = k; L < b; L += 3)
      E = (m[L] << 16 & 16711680) + (m[L + 1] << 8 & 65280) + (m[L + 2] & 255), B.push(p(E));
    return B.join("");
  }
  function y(m) {
    for (var k, b = m.length, E = b % 3, B = [], L = 16383, A = 0, _ = b - E; A < _; A += L)
      B.push(g(m, A, A + L > _ ? _ : A + L));
    return E === 1 ? (k = m[b - 1], B.push(
      e[k >> 2] + e[k << 4 & 63] + "=="
    )) : E === 2 && (k = (m[b - 2] << 8) + m[b - 1], B.push(
...
function Lo() {
  return Si || (Si = 1, Nt.read = function(e, t, n, i, s) {
    var r, o, l = s * 8 - i - 1, f = (1 << l) - 1, u = f >> 1, p = -7, g = n ? s - 1 : 0, y = n ? -1 : 1, m = e[t + g];
    for (g += y, r = m & (1 << -p) - 1, m >>= -p, p += l; p > 0; r = r * 256 + e[t + g], g += y, p -= 8)
      ;
    for (o = r & (1 << -p) - 1, r >>= -p, p += i; p > 0; o = o * 256 + e[t + g], g += y, p -= 8)
      ;
    if (r === 0)
      r = 1 - u;
    else {
    ...
    var o, l, f, u = r * 8 - s - 1, p = (1 << u) - 1, g = p >> 1, y = s === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, m = i ? 0 : r - 1, k = i ? 1 : -1, b = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
    for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (l = isNaN(t) ? 1 : 0, o = p) : (o = Math.floor(Math.log(t) / Math.LN2), t * (f = Math.pow(2, -o)) < 1 && (o--, f *= 2), o + g >= 1 ? t += y / f : t += y * Math.pow(2, 1 - g), t * f >= 2 && (o++, f /= 2), o + g >= p ? (l = 0, o = p) : o + g >= 1 ? (l = (t * f - 1) * Math.pow(2, s), o = o + g) : (l = t * Math.pow(2, g - 1) * Math.pow(2, s), o = 0)); s >= 8; e[n + m] = l & 255, m += k, l /= 256, s -= 8)
      ;
    for (o = o << s | l, u += s; u > 0; e[n + m] = o & 255, m += k, o /= 256, u -= 8)
      ;
    e[n + m - k] |= b * 128;
  }), Nt;
}
...
function xo() {
  return Ai || (Ai = 1, (function(e) {
    const t = Bo(), n = Lo(), i = typeof Symbol == "function" && typeof Symbol.for == "function" ? /* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom") : null;
    ...
    function E(h) {
      ...
      if (h.length !== void 0)
        return typeof h.length != "number" || tn(h.length) ? o(0) : m(h);
    ...
    l.prototype.swap16 = function() {
      ...
      const a = this.length;
      return a === 0 ? "" : arguments.length === 0 ? j(this, 0, a) : _.apply(this, arguments);
    ...
    function Q(h, a, c, d) {
      return dt(js(a), h, c, d);
    }
    function se(h, a, c, d) {
      return dt(Qn(a), h, c, d);
    }
    function K(h, a, c, d) {
      return dt(Fs(a, h.length - c), h, c, d);
    }
    ...
    l.prototype.readUintLE = l.prototype.readUIntLE = function(a, c, d) {
      ...
      (c === void 0 || d === void 0) && Qe(a, this.length - 8);
    ...
    l.prototype.writeBigUInt64LE = ge(function(a, c = 0) {
      return Kn(this, a, c, BigInt(0), BigInt("0xffffffffffffffff"));
      ...
      return Kn(this, a, c, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
    ...
    function vs(h, a, c) {
      ve(a, "offset"), (h[a] === void 0 || h[a + c] === void 0) && Qe(a, h.length - (c + 1));
    }
    function Cn(h, a, c, d, w, S) {
      if (h > c || h < a) {
