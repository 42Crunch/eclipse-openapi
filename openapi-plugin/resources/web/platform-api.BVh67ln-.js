import { j as x, x as Ve, f as j, Y as We, y as Re, z as me, X as ht, a6 as mt, e as ue, T as ve, a9 as vt, aa as Je, v as W, ab as Ce, ac as ne, c as B, ad as J, i as ce, ae as we, af as H, ag as Te, ah as bt, ai as Z, aj as St, ak as Rt, al as Ye, am as fe, an as Xe, ao as Ae, ap as Ie, aq as wt, ar as At, as as It, at as qe, au as Mt, u as Ot, b as Et, av as kt, aw as X } from "./TriangleExclamation.pAuQxBo5.js";
import { v as Ze, w as jt, R as Qt, I as Ct } from "./index.D0yLKFLk.js";
import { u as Tt } from "./index.DCZAKVNa.js";
import { u as qt } from "./index.KBA4ZGjU.js";
import { w as Dt, s as xt } from "./listener.CJJEzJ85.js";
...
rt.displayName = nt;
var Jt = (e) => {
  const { control: s, checked: u, bubbles: g = !0, ...d } = e, p = j.useRef(null), y = qt(u), w = Tt(s);
  return j.useEffect(() => {
  ...
  function c(a, m) {
    const o = (n, {
      ...
      const E = e({
        ...
        requestId: P,
        abort: F
      } = C, D = T.requestId !== P, _ = (N = p.get(A)) == null ? void 0 : N[E], q = () => Q(I()), z = Object.assign(v ? (
  ...
  init(s, {
    ...
    return L(s.util, {
      ...
      injectEndpoint(D, _) {
        var z;
        const q = s;
        (z = q.endpoints)[D] ?? (z[D] = {}), pt(_) ? L(q.endpoints[D], {
          name: D,
          select: b(D, _),
          initiate: k(D, _)
        }, n(t, D)) : pn(_) && L(q.endpoints[D], {
          name: D,
          select: A(),
          initiate: Q(D)
        }, n(c, D));
  ...
  function i(c) {
    const f = (o, {
      ...
      return h(() => {
        ...
        const z = (N = T.current) == null ? void 0 : N.subscriptionOptions;
        if (!q || q.arg !== k) {
        ...
        refetch: () => {
          var q;
          if (!T.current) throw new Error(Je(38));
