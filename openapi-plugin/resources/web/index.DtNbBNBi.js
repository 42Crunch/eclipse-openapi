import { j as d, c as Qt, u as Jt, b as en, e as a } from "./TriangleExclamation.uZuTZ4qX.js";
import { f as ue, u as Y, P as F, c as qe, j as Qe, A as tn, b as le, a as C, D as nn, C as rn, k as on, l as Je, S as an, m as cn, R as un, i as sn, e as ln, h as Ge } from "./index.DWATSeOz.js";
import { w as dn, b as et, R as fn, I as vn, u as pn } from "./index.DPw-_6Pf.js";
import { _ as O, b as tt, c as mn } from "./downshift.esm.DEbj-218.js";
const bo = (e) => /* @__PURE__ */ d.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", width: "1em", height: "1em", ...e, children: /* @__PURE__ */ d.jsx("path", { d: "M272 64c-8.8 0-16-7.16-16-16s7.2-16 16-16h160c8.8 0 16 7.16 16 16v160c0 8.8-7.2 16-16 16s-16-7.2-16-16V86.63L187.3 315.3c-6.2 6.3-16.4 6.3-22.6 0-6.3-6.2-6.3-16.4 0-22.6L393.4 64H272zM0 112c0-26.51 21.49-48 48-48h128c8.8 0 16 7.16 16 16s-7.2 16-16 16H48c-8.84 0-16 7.2-16 16v320c0 8.8 7.16 16 16 16h320c8.8 0 16-7.2 16-16V304c0-8.8 7.2-16 16-16s16 7.2 16 16v128c0 26.5-21.5 48-48 48H48c-26.51 0-48-21.5-48-48V112z" }) }), hn = {
  security: {},
  scanServer: "",
  tryitServer: "",
  useGlobalBlocks: !0,
...
var Me = "focusScope.autoFocusOnMount", Se = "focusScope.autoFocusOnUnmount", Ue = { bubbles: !1, cancelable: !0 }, wn = "FocusScope", rt = a.forwardRef((e, t) => {
  ...
  a.useEffect(() => {
    if (r) {
      let l = function(y) {
        ...
        const b = y.target;
        c.contains(b) ? s.current = b : k(s.current, { select: !0 });
      }, h = function(y) {
        if (g.paused || !c) return;
        const b = y.relatedTarget;
        b !== null && (c.contains(b) || k(s.current, { select: !0 }));
      }, S = function(y) {
      ...
      return c && E.observe(c, { childList: !0, subtree: !0 }), () => {
        document.removeEventListener("focusin", l), document.removeEventListener("focusout", h), E.disconnect();
      };
    }
    ...
    if (c) {
      ...
      if (!c.contains(l)) {
        ...
        c.addEventListener(Me, m), c.dispatchEvent(S), S.defaultPrevented || (Mn(En(ot(c)), { select: !0 }), document.activeElement === l && k(c));
      }
      return () => {
  ...
  const M = a.useCallback(
    (l) => {
      ...
      if (h && S) {
        const E = l.currentTarget, [y, b] = Sn(E);
        y && b ? !l.shiftKey && S === b ? (l.preventDefault(), n && k(y, { select: !0 })) : l.shiftKey && S === y && (l.preventDefault(), n && k(b, { select: !0 })) : S === E && l.preventDefault();
      }
    },
    [n, r, g.paused]
  );
...
var ut = Ln(), be = function() {
}, de = a.forwardRef(function(e, t) {
  var n = a.useRef(null), r = a.useState({
    onScrollCapture: be,
    onWheelCapture: be,
    onTouchMoveCapture: be
  }), o = r[0], u = r[1], i = e.forwardProps, c = e.children, p = e.className, m = e.removeScrollBar, v = e.enabled, s = e.shards, f = e.sideCar, g = e.noIsolation, M = e.inert, l = e.allowPinchZoom, h = e.as, S = h === void 0 ? "div" : h, E = e.gapMode, y = tt(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), b = f, x = Nn([n, t]), A = O(O({}, y), o);
  return a.createElement(
    a.Fragment,
    null,
    v && a.createElement(b, { sideCar: ut, removeScrollBar: m, shards: s, noIsolation: g, inert: M, setCallbacks: u, allowPinchZoom: !!l, lockRef: n, gapMode: E }),
...
var V = xe ? { passive: !1 } : !1, qn = function(e) {
...
function ur(e) {
  ...
  var c = a.useCallback(function(l, h) {
    ...
    var S = oe(l), E = n.current, y = "deltaX" in l ? l.deltaX : E[0] - S[0], b = "deltaY" in l ? l.deltaY : E[1] - S[1], x, A = l.target, I = Math.abs(y) > Math.abs(b) ? "h" : "v";
    ...
    if (K ? x = I : (x = I === "v" ? "h" : "v", K = Ye(I, A)), !K)
      return !1;
    if (!r.current && "changedTouches" in l && (y || b) && (r.current = x), !x)
      return !0;
    var L = r.current || x;
    return rr(L, h, l, L === "h" ? y : b, !0);
  }, []), p = a.useCallback(function(l) {
    var h = l;
    if (!(!H.length || H[H.length - 1] !== u)) {
      var S = "deltaY" in h ? $e(h) : oe(h), E = t.current.filter(function(x) {
      ...
      if (!E) {
        ...
        }), b = y.length > 0 ? c(h, y[0]) : !i.current.noIsolation;
        b && h.cancelable && h.preventDefault();
      }
    }
  }, []), m = a.useCallback(function(l, h, S, E) {
    var y = { name: l, delta: h, target: S, should: E, shadowParent: sr(S) };
  ...
  return a.createElement(
    ...
    g ? a.createElement(Zn, { gapMode: e.gapMode }) : null
  );
}
function sr(e) {
...
var P = "MenuContent", [Sr, Ie] = j(P), Mt = a.forwardRef(
  (e, t) => {
    ...
    return /* @__PURE__ */ d.jsx(Z.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ d.jsx(le, { present: r || u.open, children: /* @__PURE__ */ d.jsx(Z.Slot, { scope: e.__scopeMenu, children: i.modal ? /* @__PURE__ */ d.jsx(yr, { ...o, ref: t }) : /* @__PURE__ */ d.jsx(Cr, { ...o, ref: t }) }) }) });
  }
), yr = a.forwardRef(
  (e, t) => {
  ...
  (e, t) => {
    const {
      ...
      ...l
    } = e, h = G(P, n), S = J(P, n), E = fe(n), y = mt(n), b = pr(n), [x, A] = a.useState(null), I = a.useRef(null), K = Y(t, I, h.onContentChange), L = a.useRef(0), ee = a.useRef(""), $t = a.useRef(0), pe = a.useRef(null), Oe = a.useRef("right"), me = a.useRef(0), zt = M ? ft : a.Fragment, Zt = M ? { as: an, allowPinchZoom: !0 } : void 0, qt = (w) => {
      var B, Fe;
      const _ = ee.current + w, D = b().filter((T) => !T.disabled), N = document.activeElement, he = (B = D.find((T) => T.ref.current === N)) == null ? void 0 : B.textValue, ge = D.map((T) => T.textValue), Le = kr(ge, _, he), $ = (Fe = D.find((T) => T.textValue === Le)) == null ? void 0 : Fe.ref.current;
      (function T(je) {
    ...
    return /* @__PURE__ */ d.jsx(
      Sr,
      {
        ...
        children: /* @__PURE__ */ d.jsx(zt, { ...Zt, children: /* @__PURE__ */ d.jsx(
          rt,
          {
            asChild: !0,
            trapped: o,
                    ...
                    children: /* @__PURE__ */ d.jsx(
                      rn,
                      {
                        ...
                        onKeyDown: C(l.onKeyDown, (w) => {
                          ...
                          D && (w.key === "Tab" && w.preventDefault(), !N && he && qt(w.key));
                          const ge = I.current;
                          if (w.target !== ge || !dr.includes(w.key)) return;
                          w.preventDefault();
                          const $ = b().filter((B) => !B.disabled).map((B) => B.ref.current);
...
Mt.displayName = P;
var br = "MenuGroup", Ae = a.forwardRef(
  (e, t) => {
...
Ae.displayName = br;
var Er = "MenuLabel", St = a.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
...
var se = "MenuItem", Ze = "menu.itemSelect", ve = a.forwardRef(
  (e, t) => {
    const { disabled: n = !1, onSelect: r, ...o } = e, u = a.useRef(null), i = J(se, e.__scopeMenu), c = Ie(se, e.__scopeMenu), p = Y(t, u), m = a.useRef(!1), v = () => {
      const s = u.current;
      if (!n && s) {
        const f = new CustomEvent(Ze, { bubbles: !0, cancelable: !0 });
        s.addEventListener(Ze, (g) => r == null ? void 0 : r(g), { once: !0 }), cn(s, f), f.defaultPrevented ? m.current = !1 : i.onClose();
      }
    };
    return /* @__PURE__ */ d.jsx(
      yt,
      ...
      yt,
      {
        ...
        onPointerLeave: C(
          ...
          q((s) => {
            ...
            if (f) {
              const l = (M = n.content) == null ? void 0 : M.dataset.side, h = l === "right", S = h ? -5 : 5, E = f[h ? "left" : "right"], y = f[h ? "right" : "left"];
...
var Nt = "MenuSubContent", kt = a.forwardRef(
  (e, t) => {
    ...
    return /* @__PURE__ */ d.jsx(Z.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ d.jsx(le, { present: r || u.open, children: /* @__PURE__ */ d.jsx(Z.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ d.jsx(
      De,
      {
        id: c.contentId,
...
var Fr = ht, jr = _e, Gr = wt, Kr = Mt, Ur = Ae, Br = St, Wr = ve, Vr = Ct, Hr = Et, Xr = Rt, Yr = Pt, $r = It, zr = Dt, Zr = Tt, qr = kt, ke = "DropdownMenu", [Qr, ko] = qe(
  ke,
  [pt]
