import { e as s, j as u, w as H, v as z, V as N, x as g, U as S, _ as J, ad as Q, a5 as Z, a4 as ee, a3 as te } from "./webapp.CeAUXIIl.js";
import { c as G, A as oe, C as re, a as ne, R as se } from "./index.BgEBtJ05.js";
...
var D = "Tooltip", [ue, R] = _(D), U = (e) => {
  const {
    ...
    delayDuration: f
  } = e, a = j(D, e.__scopeTooltip), p = A(o), [l, d] = s.useState(null), x = Z(), v = s.useRef(0), h = c ?? a.disableHoverableContent, y = f ?? a.delayDuration, T = s.useRef(!1), [m = !1, C] = ee({
    prop: r,
    defaultProp: n,
    onChange: (I) => {
      I ? (a.onOpen(), document.dispatchEvent(new CustomEvent(O))) : a.onClose(), i == null || i(I);
    }
  }), b = s.useMemo(() => m ? T.current ? "delayed-open" : "instant-open" : "closed", [m]), E = s.useCallback(() => {
...
var w = "TooltipContent", W = s.forwardRef(
  (e, o) => {
    ...
    return /* @__PURE__ */ u.jsx(S, { present: r || c.open, children: c.disableHoverableContent ? /* @__PURE__ */ u.jsx(X, { side: n, ...i, ref: o }) : /* @__PURE__ */ u.jsx(fe, { side: n, ...i, ref: o }) });
  }
), fe = s.forwardRef((e, o) => {
  const t = R(w, e.__scopeTooltip), r = j(w, e.__scopeTooltip), n = s.useRef(null), i = N(o, n), [c, f] = s.useState(null), { trigger: a, onClose: p } = t, l = n.current, { onPointerInTransitChange: d } = r, x = s.useCallback(() => {
    ...
    (h, y) => {
      const T = h.currentTarget, m = { x: h.clientX, y: h.clientY }, C = xe(m, T.getBoundingClientRect()), b = Te(m, C), E = ye(y.getBoundingClientRect()), P = me([...b, ...E]);
      f(P), d(!0);
    },
    [d]
  );
...
var Pe = B, Re = U, _e = Y, Ae = q, De = W, Oe = $;
export {
  Oe as A,
  De as C,
  Pe as P,
