import { f as n, j as d, K as D, Z as F, L as P, X as O, _ as S, M as j } from "./TriangleExclamation.BLKAXJ8l.js";
import { u as H } from "./index.Cyn4uFgE.js";
function K(e) {
...
Z.displayName = B;
var M = "CheckboxBubbleInput", T = n.forwardRef(
  ({ __scopeCheckbox: e, ...r }, a) => {
    ...
    n.useEffect(() => {
      ...
      if (x !== t && y) {
        ...
        c.indeterminate = b(t), y.call(c, b(t) ? !1 : t), c.dispatchEvent(L);
      }
    }, [f, x, t, s]);
