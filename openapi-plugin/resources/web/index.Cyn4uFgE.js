import { f as R, U as Ae, j as Y, L as Rt, az as yt, K as Re, _ as Xt, J as Se } from "./TriangleExclamation.BLKAXJ8l.js";
const Ce = ["top", "right", "bottom", "left"], K = Math.min, W = Math.max, at = Math.round, ct = Math.floor, j = (t) => ({
  x: t,
  y: t
}), Oe = {
  left: "right",
...
const We = (t) => ({
  ...
  async fn(e) {
    ...
    const M = y / 2 - v / 2, F = S / 2 - m[p] / 2 - 1, D = K(u[g], F), $ = K(u[x], F), k = D, P = S - m[p] - $, O = S / 2 - m[p] / 2 + M, N = vt(k, O, P), E = !l.arrow && tt(r) != null && O !== N && i.reference[p] / 2 - (O < k ? D : $) - m[p] / 2 < 0, L = E ? O < k ? O - k : O - P : 0;
    return {
      [d]: h[d] + L,
      data: {
        [d]: N,
...
const Be = function(t) {
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const x = m - f.top - f.bottom, b = p - f.left - f.right, y = K(m - f[w], x), v = K(p - f[g], b), C = !e.middlewareData.shift;
      let S = y, M = v;
...
const Ke = ["transform", "translate", "scale", "rotate", "perspective"], Ze = ["transform", "translate", "scale", "rotate", "perspective", "filter"], Je = ["paint", "layout", "strict", "content"];
function Pt(t) {
  const e = Et(), n = _(t) ? z(t) : t;
  return Ke.some((o) => n[o] ? n[o] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1) || !e && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !e && (n.filter ? n.filter !== "none" : !1) || Ze.some((o) => (n.willChange || "").includes(o)) || Je.some((o) => (n.contain || "").includes(o));
}
function Ge(t) {
  let e = Z(t);
  for (; I(e) && !Q(e); ) {
...
function Kt(t) {
  const e = Z(t);
  return Q(e) ? t.ownerDocument ? t.ownerDocument.body : t.body : I(e) && it(e) ? e : Kt(e);
}
function rt(t, e, n) {
  var o;
  e === void 0 && (e = []), n === void 0 && (n = !0);
  const r = Kt(t), i = r === ((o = t.ownerDocument) == null ? void 0 : o.body), s = H(r);
  if (i) {
    const c = At(s);
...
function J(t, e, n, o) {
  ...
  let s = j(1);
  e && (o ? _(o) && (s = G(o)) : s = G(t));
  const c = en(i, n, o) ? Jt(i) : j(0);
  let l = (r.left + c.x) / s.x, a = (r.top + c.y) / s.y, f = r.width / s.x, u = r.height / s.y;
  if (i) {
    const h = H(i), d = o && _(o) ? H(o) : o;
    let p = h, m = At(p);
    for (; m && o && d !== p; ) {
      const w = G(m), g = m.getBoundingClientRect(), x = z(m), b = g.left + (m.clientLeft + parseFloat(x.paddingLeft)) * w.x, y = g.top + (m.clientTop + parseFloat(x.paddingTop)) * w.y;
...
function nn(t) {
  ...
  if ((u || !u && !i) && ((et(o) !== "body" || it(s)) && (l = mt(o)), I(o))) {
    const d = J(o);
    a = G(o), f.x = d.x + o.clientLeft, f.y = d.y + o.clientTop;
  }
  const h = s && !u && !i ? Gt(s, l) : j(0);
  return {
    width: n.width * a.x,
    height: n.height * a.y,
...
function ln(t, e) {
  const n = J(t, !0, e === "fixed"), o = n.top + t.clientTop, r = n.left + t.clientLeft, i = I(t) ? G(t) : j(1), s = t.clientWidth * i.x, c = t.clientHeight * i.y, l = r * i.x, a = o * i.y;
  return {
    width: s,
    height: c,
    x: l,
...
function an(t, e) {
  ...
  for (; _(s) && !Q(s); ) {
    const c = z(s), l = Pt(s);
    !l && c.position === "fixed" && (r = null), (i ? !l && !r : !l && c.position === "static" && !!r && cn.has(r.position) || it(s) && !l && Qt(t, s)) ? o = o.filter((f) => f !== s) : r = c, s = Z(s);
  }
  return e.set(t, o), o;
}
function fn(t) {
...
function dn(t, e, n) {
  const o = I(e), r = X(e), i = n === "fixed", s = J(t, !0, i, e);
  let c = {
    scrollLeft: 0,
    scrollTop: 0
  };
  ...
  i && !o && r && a();
  const f = r && !o && !i ? Gt(r, c) : j(0), u = s.left + c.scrollLeft - l.x - f.x, h = s.top + c.scrollTop - l.y - f.y;
  return {
    x: u,
    y: h,
    width: s.width,
...
function te(t, e) {
  ...
  for (; o && qe(o) && wt(o); )
    o = Vt(o, e);
  return o && Q(o) && wt(o) && !Pt(o) ? n : o || Ge(t) || n;
}
