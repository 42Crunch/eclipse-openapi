import { j as c, c as ln, u as pn, b as fn, v as he, e as a, U as z, V as L, X as mn, x as M, Y as vn, Z as Mn, _ as hn, w as A, y as we, $ as ge, a0 as wn, a1 as gn, a2 as xn, a3 as _n, a4 as Cn, a5 as ve } from "./webapp.CeAUXIIl.js";
import { q as Rn, v as xe, R as Sn, I as yn, w as In } from "./index.CVo6ZNUd.js";
import { c as _e, A as En, C as Pn, a as Dn, R as bn } from "./index.BgEBtJ05.js";
...
var re = "MenuPortal", [Un, Ee] = I(re, {
  ...
  return /* @__PURE__ */ c.jsx(Un, { scope: n, forceMount: r, children: /* @__PURE__ */ c.jsx(z, { present: r || s.open, children: /* @__PURE__ */ c.jsx(_n, { asChild: !0, container: o, children: t }) }) });
};
Pe.displayName = re;
var _ = "MenuContent", [Bn, te] = I(_), De = a.forwardRef(
  (e, n) => {
    ...
    return /* @__PURE__ */ c.jsx(j.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ c.jsx(z, { present: t || s.open, children: /* @__PURE__ */ c.jsx(j.Slot, { scope: e.__scopeMenu, children: i.modal ? /* @__PURE__ */ c.jsx($n, { ...o, ref: n }) : /* @__PURE__ */ c.jsx(Vn, { ...o, ref: n }) }) }) });
  }
), $n = a.forwardRef(
  (e, n) => {
...
De.displayName = _;
var Xn = "MenuGroup", ae = a.forwardRef(
  (e, n) => {
...
be.displayName = Yn;
var X = "MenuItem", Me = "menu.itemSelect", W = a.forwardRef(
  (e, n) => {
    const { disabled: r = !1, onSelect: t, ...o } = e, s = a.useRef(null), i = G(X, e.__scopeMenu), l = te(X, e.__scopeMenu), m = L(n, s), v = a.useRef(!1), p = () => {
      const u = s.current;
      if (!r && u) {
...
var Ae = a.forwardRef(
  (e, n) => {
    const { __scopeMenu: r, disabled: t = !1, textValue: o, ...s } = e, i = te(X, r), l = ye(r), m = a.useRef(null), v = L(n, m), [p, u] = a.useState(!1), [f, w] = a.useState("");
    return a.useEffect(() => {
      const h = m.current;
...
), zn = "MenuCheckboxItem", Te = a.forwardRef(
  (e, n) => {
    ...
    return /* @__PURE__ */ c.jsx(Le, { scope: e.__scopeMenu, checked: r, children: /* @__PURE__ */ c.jsx(
      W,
      {
        ...
        "aria-checked": Y(r) ? "mixed" : r,
        ...o,
        ref: n,
        "data-state": ce(r),
        onSelect: M(
          o.onSelect,
          () => t == null ? void 0 : t(Y(r) ? !0 : !r),
          { checkForDefaultPrevented: !1 }
        )
      }
    ) });
...
var $e = "MenuSubContent", Ve = a.forwardRef(
  (e, n) => {
    ...
    return /* @__PURE__ */ c.jsx(j.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ c.jsx(z, { present: t || s.open, children: /* @__PURE__ */ c.jsx(j.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ c.jsx(
      oe,
      {
        id: l.contentId,
...
var He = "DropdownMenuTrigger", We = a.forwardRef(
  (e, n) => {
    const { __scopeDropdownMenu: r, disabled: t = !1, ...o } = e, s = Ye(He, r), i = g(r);
...
var Ze = "DropdownMenuContent", Je = a.forwardRef(
  (e, n) => {
    const { __scopeDropdownMenu: r, ...t } = e, o = Ye(Ze, r), s = g(r), i = a.useRef(!1);
    return /* @__PURE__ */ c.jsx(
      ur,
      {
        id: o.contentId,
...
Gr.displayName = Fr;
var nt = ze, rt = We, tt = qe, ot = Je, at = Qe, st = en, ct = nn, ut = rn, it = tn;
export {
  sr as A,
  ot as C,
  ir as G,
