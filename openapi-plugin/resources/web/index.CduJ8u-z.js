import { f as s, j as u, L as H, K as Z, Y as $, X as J, _ as N, M as m, Z as S, a1 as Q, a7 as ee, ay as te } from "./TriangleExclamation.BLKAXJ8l.js";
import { c as G, R as oe, A as re, C as ne, a as se } from "./index.Cyn4uFgE.js";
...
var le = F, [A] = Z("Tooltip", [
  G
]), L = G(), V = "TooltipProvider", ce = 700, O = "tooltip.open", [ue, j] = A(V), Y = (e) => {
  const {
    __scopeTooltip: o,
    delayDuration: t = ce,
...
var R = "Tooltip", [pe, _] = A(R), B = (e) => {
  const {
    ...
    delayDuration: v
  } = e, a = j(R, e.__scopeTooltip), d = L(o), [c, f] = s.useState(null), h = $(), p = s.useRef(0), x = i ?? a.disableHoverableContent, y = v ?? a.delayDuration, T = s.useRef(!1), [C, g] = J({
    prop: r,
    defaultProp: n ?? !1,
    onChange: (I) => {
      I ? (a.onOpen(), document.dispatchEvent(new CustomEvent(O))) : a.onClose(), l?.(I);
    },
    caller: R
  }), b = s.useMemo(() => C ? T.current ? "delayed-open" : "instant-open" : "closed", [C]), E = s.useCallback(() => {
    window.clearTimeout(p.current), p.current = 0, T.current = !1, g(!0);
  }, [g]), P = s.useCallback(() => {
    window.clearTimeout(p.current), p.current = 0, g(!1);
  }, [g]), M = s.useCallback(() => {
    window.clearTimeout(p.current), p.current = window.setTimeout(() => {
      T.current = !0, g(!0), p.current = 0;
    }, y);
  }, [y, g]);
  return s.useEffect(() => () => {
    ...
    pe,
    {
      ...
      onTriggerEnter: s.useCallback(() => {
        a.isOpenDelayedRef.current ? M() : E();
      }, [a.isOpenDelayedRef, M, E]),
...
B.displayName = R;
var D = "TooltipTrigger", U = s.forwardRef(
  (e, o) => {
    const { __scopeTooltip: t, ...r } = e, n = _(D, t), l = j(D, t), i = L(t), v = s.useRef(null), a = N(o, v, n.onTriggerChange), d = s.useRef(!1), c = s.useRef(!1), f = s.useCallback(() => d.current = !1, []);
...
var w = "TooltipContent", q = s.forwardRef(
  (e, o) => {
    ...
    return /* @__PURE__ */ u.jsx(S, { present: r || i.open, children: i.disableHoverableContent ? /* @__PURE__ */ u.jsx(K, { side: n, ...l, ref: o }) : /* @__PURE__ */ u.jsx(ve, { side: n, ...l, ref: o }) });
  }
), ve = s.forwardRef((e, o) => {
  const t = _(w, e.__scopeTooltip), r = j(w, e.__scopeTooltip), n = s.useRef(null), l = N(o, n), [i, v] = s.useState(null), { trigger: a, onClose: d } = t, c = n.current, { onPointerInTransitChange: f } = r, h = s.useCallback(() => {
    ...
    (x, y) => {
      const T = x.currentTarget, C = { x: x.clientX, y: x.clientY }, g = ye(C, T.getBoundingClientRect()), b = ge(C, g), E = Ce(y.getBoundingClientRect()), P = we([...b, ...E]);
      v(P), f(!0);
    },
    [f]
  );
  return s.useEffect(() => () => h(), [h]), s.useEffect(() => {
    ...
    if (i) {
      const x = (y) => {
        const T = y.target, C = { x: y.clientX, y: y.clientY }, g = a?.contains(T) || c?.contains(T), b = !me(C, i);
        g ? h() : b && (h(), d());
      };
      return document.addEventListener("pointermove", x), () => document.removeEventListener("pointermove", x);
    }
  }, [a, c, i, d, h]), /* @__PURE__ */ u.jsx(K, { ...e, ref: l });
}), [he, xe] = A(R, { isInside: !1 }), Te = te("TooltipContent"), K = s.forwardRef(
  (e, o) => {
    const {
      __scopeTooltip: t,
      children: r,
...
q.displayName = w;
var W = "TooltipArrow", z = s.forwardRef(
  (e, o) => {
...
var Re = Y, _e = B, Ae = U, Le = X, Oe = q, De = z;
export {
  De as A,
  Oe as C,
  Re as P,
