import { e as s, j as u } from "./TriangleExclamation.nXQi8F2Q.js";
import { P as H, c as z, i as N, b as S, A as J, a as m, d as G, D as Q, C as Z, n as ee, j as te, g as oe, f as re, R as ne, h as se } from "./index.DSuKNAAP.js";
...
var D = "Tooltip", [ue, R] = _(D), U = (e) => {
  const {
    ...
    delayDuration: f
  } = e, a = L(D, e.__scopeTooltip), p = A(o), [l, d] = s.useState(null), x = oe(), v = s.useRef(0), h = c ?? a.disableHoverableContent, y = f ?? a.delayDuration, T = s.useRef(!1), [g = !1, C] = re({
    prop: r,
    defaultProp: n,
    onChange: (I) => {
      I ? (a.onOpen(), document.dispatchEvent(new CustomEvent(O))) : a.onClose(), i == null || i(I);
    }
  }), b = s.useMemo(() => g ? T.current ? "delayed-open" : "instant-open" : "closed", [g]), P = s.useCallback(() => {
  ...
  (e, o) => {
    ...
    return s.useEffect(() => () => document.removeEventListener("pointerup", d), [d]), /* @__PURE__ */ u.jsx(J, { asChild: !0, ...c, children: /* @__PURE__ */ u.jsx(
      H.button,
      {
        ...
        ...r,
        ref: a,
        onPointerMove: m(e.onPointerMove, (x) => {
...
var w = "TooltipContent", W = s.forwardRef(
  ...
  const t = R(w, e.__scopeTooltip), r = L(w, e.__scopeTooltip), n = s.useRef(null), i = S(o, n), [c, f] = s.useState(null), { trigger: a, onClose: p } = t, l = n.current, { onPointerInTransitChange: d } = r, x = s.useCallback(() => {
    ...
    (h, y) => {
      const T = h.currentTarget, g = { x: h.clientX, y: h.clientY }, C = xe(g, T.getBoundingClientRect()), b = Te(g, C), P = ye(y.getBoundingClientRect()), E = ge([...b, ...P]);
      f(E), d(!0);
    },
    [d]
  );
  return s.useEffect(() => () => x(), [x]), s.useEffect(() => {
    ...
    if (c) {
      const h = (y) => {
        const T = y.target, g = { x: y.clientX, y: y.clientY }, C = (a == null ? void 0 : a.contains(T)) || (l == null ? void 0 : l.contains(T)), b = !Ce(g, c);
        C ? x() : b && (x(), p());
      };
...
function ge(e) {
  const o = e.slice();
  return o.sort((t, r) => t.x < r.x ? -1 : t.x > r.x ? 1 : t.y < r.y ? -1 : t.y > r.y ? 1 : 0), me(o);
}
function me(e) {
