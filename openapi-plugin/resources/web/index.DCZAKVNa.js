import { f as P, K as Ae, j as I, y as Pt, az as yt, x as Re, Y as Kt, A as Pe } from "./TriangleExclamation.pAuQxBo5.js";
const Ce = ["top", "right", "bottom", "left"], q = Math.min, F = Math.max, ft = Math.round, lt = Math.floor, K = (t) => ({
  x: t,
  y: t
}), Oe = {
  left: "right",
...
function Bt(t, e, n) {
  ...
  const r = U(e), s = St(e), c = Ot(s), a = X(e), l = r === "y", f = o.x + o.width / 2 - i.width / 2, d = o.y + o.height / 2 - i.height / 2, m = o[c] / 2 - i[c] / 2;
  let u;
  switch (a) {
    case "top":
      u = {
...
async function ot(t, e) {
  ...
  const {
    ...
    altBoundary: m = !1,
    padding: u = 0
  } = Y(e, t), p = Ut(u), w = c[m ? d === "floating" ? "reference" : "floating" : d], g = dt(await r.getClippingRect({
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if ((n = r.arrow) != null && n.alignmentOffset)
        return {};
      const g = X(i), x = U(c), b = X(c) === c, y = await (a.isRTL == null ? void 0 : a.isRTL(l.floating)), v = m || (b || !h ? [ut(c)] : De(c)), R = p !== "none";
...
async function He(t, e) {
  const {
    ...
    platform: o,
    elements: i
  } = t, r = await (o.isRTL == null ? void 0 : o.isRTL(i.floating)), s = X(n), c = tt(n), a = U(n) === "y", l = ["left", "top"].includes(s) ? -1 : 1, f = r && a ? -1 : 1, d = Y(e, t);
  let {
    mainAxis: m,
    crossAxis: u,
    alignmentAxis: p
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const {
        ...
        ...l
      } = Y(t, e), f = await ot(e, l), d = X(i), m = tt(i), u = U(i) === "y", {
        width: p,
        height: h
      } = r.floating;
      let w, g;
...
function Gt(t) {
  const e = Z(t);
  return Q(e) ? t.ownerDocument ? t.ownerDocument.body : t.body : j(e) && rt(e) ? e : Gt(e);
}
function it(t, e, n) {
  var o;
...
function Xe(t) {
  ...
  if ((d || !d && !r) && ((et(o) !== "body" || rt(s)) && (a = gt(o)), j(o))) {
    const m = G(o);
    l = J(o), f.x = m.x + o.clientLeft, f.y = m.y + o.clientTop;
  }
  return {
    width: n.width * l.x,
    height: n.height * l.y,
...
function Rt(t, e) {
  ...
  return e ? e.left + n : G(V(t)).left + n;
}
function Ke(t) {
...
function Ze(t, e) {
  const n = G(t, !0, e === "fixed"), o = n.top + t.clientTop, i = n.left + t.clientLeft, r = j(t) ? J(t) : K(1), s = t.clientWidth * r.x, c = t.clientHeight * r.y, a = i * r.x, l = o * r.y;
  return {
    width: s,
    height: c,
    x: a,
...
function te(t, e) {
  const n = Z(t);
  return n === e || !_(n) || Q(n) ? !1 : B(n).position === "fixed" || te(n, e);
}
function Ge(t, e) {
  const n = e.get(t);
  if (n)
  ...
  for (; _(s) && !Q(s); ) {
    const c = B(s), a = Et(s);
    !a && c.position === "fixed" && (i = null), (r ? !a && !i : !a && c.position === "static" && !!i && ["absolute", "fixed"].includes(i.position) || rt(s) && !a && te(t, s)) ? o = o.filter((f) => f !== s) : i = c, s = Z(s);
  }
  return e.set(t, o), o;
}
function Je(t) {
  ...
  const s = [...n === "clippingAncestors" ? ht(e) ? [] : Ge(e, this._c) : [].concat(n), o], c = s[0], a = s.reduce((l, f) => {
    const d = It(e, f, i);
...
function tn(t, e, n) {
  const o = j(e), i = V(e), r = n === "fixed", s = G(t, !0, r, e);
  let c = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
const cn = We, ln = _e, an = Ne, fn = ze, un = Fe, Xt = ke, dn = Be, pn = (t, e, n) => {
...
function mn(t) {
  ...
  const [p, h] = P.useState(null), [w, g] = P.useState(null), x = P.useCallback((A) => {
    ...
    $.current && (A.platform = $.current), pn(R.current, O.current, A).then((M) => {
      ...
      C.current && !pt(T.current, z) && (T.current = z, Ae.flushSync(() => {
        d(z);
      }));
    });
  }, [m, e, n, $, k]);
...
var ce = "PopperAnchor", le = P.forwardRef(
  (t, e) => {
    const { __scopePopper: n, virtualRef: o, ...i } = t, r = re(ce, n), s = P.useRef(null), c = Kt(e, s);
    return P.useEffect(() => {
...
var Mt = "PopperContent", [Sn, En] = ie(Mt), ae = P.forwardRef(
  (t, e) => {
    ...
    const {
      ...
      onPlaced: p,
      ...h
    } = t, w = re(Mt, n), [g, x] = P.useState(null), b = Kt(e, (nt) => x(nt)), [y, v] = P.useState(null), R = Cn(y), O = (R == null ? void 0 : R.width) ?? 0, T = (R == null ? void 0 : R.height) ?? 0, N = o + (r !== "center" ? "-" + r : ""), L = typeof f == "number" ? f : { top: 0, right: 0, bottom: 0, left: 0, ...f }, $ = Array.isArray(l) ? l : [l], k = $.length > 0, S = {
      padding: L,
      boundary: $.filter(Tn),
