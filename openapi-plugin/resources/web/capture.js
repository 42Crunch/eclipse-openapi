    ...
    Object.keys(t.uploadStatus).length > 0 && /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
      ...
      /* @__PURE__ */ e.jsxs(ot, { children: [
        /* @__PURE__ */ e.jsx(rt, { children: Object.entries(t.uploadStatus || {}).map(([i, r]) => /* @__PURE__ */ e.jsxs(st, { children: [
          ...
          t.status === "running" && /* @__PURE__ */ e.jsx(lt, { children: /* @__PURE__ */ e.jsx(H, {}) })
        ] }, `file-${i}`)) }),
...
`;
function mt() {
  const t = x(), { items: s, selectedId: n } = m((o) => o.capture), i = ({ sectionId: o, itemId: d }) => t(He(d)), r = [
    {
      id: "capture",
      title: "Capture",
      items: s.map((o) => ({
...
function ft(t) {
  switch (t) {
    ...
    case "running":
      return /* @__PURE__ */ e.jsx(H, { className: "spinning" });
    case "finished":
