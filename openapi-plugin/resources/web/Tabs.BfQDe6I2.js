import { f as p, X as B, j as o, K as N, Y as w, L as f, Z as P, M as h, T as s, e as v, S as V } from "./TriangleExclamation.BLKAXJ8l.js";
import { u as D, c as j, R as G, I as L } from "./index.Cju85Yia.js";
var m = "Tabs", [K] = N(m, [
  j
]), y = j(), [z, T] = K(m), C = p.forwardRef(
  (e, i) => {
    const {
      __scopeTabs: d,
      value: r,
...
var A = "TabsTrigger", F = p.forwardRef(
  (e, i) => {
    const { __scopeTabs: d, value: r, disabled: n = !1, ...a } = e, t = T(A, d), u = y(d), x = M(t.baseId, r), b = S(t.baseId, r), l = r === t.value;
    return /* @__PURE__ */ o.jsx(
      L,
      {
        asChild: !0,
...
var R = "TabsContent", E = p.forwardRef(
  (e, i) => {
    const { __scopeTabs: d, value: r, forceMount: n, children: a, ...t } = e, u = T(R, d), x = M(u.baseId, r), b = S(u.baseId, r), l = r === u.value, c = p.useRef(l);
    return p.useEffect(() => {
