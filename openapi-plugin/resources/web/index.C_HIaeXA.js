import { e as f, j as D, $ as Ot, a4 as Te, a5 as Me } from "./TriangleExclamation.9XEPiFVq.js";
...
var ee = f.forwardRef((t, e) => {
  const { children: n, ...o } = t, r = f.Children.toArray(n), i = r.find(Fe);
  if (i) {
...
const tn = ["top", "right", "bottom", "left"], I = Math.min, F = Math.max, mt = Math.round, ut = Math.floor, X = (t) => ({
  x: t,
  y: t
}), en = {
  left: "right",
...
const fn = (t) => ({
  ...
  async fn(e) {
    ...
    const R = v / 2 - b / 2, T = E / 2 - g[h] / 2 - 1, O = I(d[w], T), W = I(d[x], T), $ = O, k = E - g[h] - W, S = E / 2 - g[h] / 2 + R, M = Ct($, S, k), _ = !l.arrow && nt(r) != null && S !== M && i.reference[h] / 2 - (S < $ ? O : W) - g[h] / 2 < 0, C = _ ? S < $ ? S - $ : S - k : 0;
    return {
      [p]: m[p] + C,
      data: {
        [p]: M,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if (O = [...O, {
        ...
        let _ = ($ = O.filter((C) => C.overflows[0] <= 0).sort((C, N) => C.overflows[1] - N.overflows[1])[0]) == null ? void 0 : $.placement;
        if (!_)
          switch (p) {
            case "bestFit": {
              var k;
              const C = (k = O.filter((N) => {
                if (P) {
                ...
                return !0;
              }).map((N) => [N.placement, N.overflows.filter((L) => L > 0).reduce((L, vt) => L + vt, 0)]).sort((N, L) => N[1] - L[1])[0]) == null ? void 0 : k[0];
              C && (_ = C);
              break;
            }
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if (d ? P = u || v ? I(A, w) : w : b = u || v ? I(x, y) : y, v && !u) {
        const R = F(l.left, 0), T = F(l.right, 0), O = F(l.top, 0), W = F(l.bottom, 0);
        d ? P = m - 2 * (R !== 0 || T !== 0 ? R + T : F(l.left, l.right)) : b = p - 2 * (O !== 0 || W !== 0 ? O + W : F(l.top, l.bottom));
      }
      await s({
        ...e,
        availableWidth: P,
...
function st(t, e, n) {
  ...
  const r = se(t), i = r === ((o = t.ownerDocument) == null ? void 0 : o.body), s = B(r);
...
function G(t, e, n, o) {
  ...
  if (i) {
    ...
    for (; g && o && p !== h; ) {
      ...
      l *= y.x, a *= y.y, u *= y.x, d *= y.y, l += A, a += v, h = B(g), g = h.frameElement;
    }
  }
  return gt({
    width: u,
...
function Pn(t) {
  const e = Y(t), n = xt(t), o = t.ownerDocument.body, r = F(e.scrollWidth, e.clientWidth, o.scrollWidth, o.clientWidth), i = F(e.scrollHeight, e.clientHeight, o.scrollHeight, o.clientHeight);
  let s = -n.scrollLeft + le(t);
  const c = -n.scrollTop;
  return j(o).direction === "rtl" && (s += F(e.clientWidth, o.clientWidth) - r), {
    width: r,
    height: i,
    x: s,
    y: c
...
function Cn(t, e) {
  const n = B(t), o = Y(t), r = n.visualViewport;
...
function Sn(t) {
  ...
  const s = [...n === "clippingAncestors" ? yt(e) ? [] : On(e, this._c) : [].concat(n), o], c = s[0], l = s.reduce((a, u) => {
    const d = Kt(e, u, r);
    return a.top = F(d.top, a.top), a.right = I(d.right, a.right), a.bottom = I(d.bottom, a.bottom), a.left = F(d.left, a.left), a;
  }, Kt(e, c, r));
  return {
...
const kn = mn, _n = hn, Fn = un, Bn = wn, jn = dn, Gt = fn, In = gn, Hn = (t, e, n) => {
...
function zn(t) {
  ...
  const [h, g] = f.useState(null), [y, w] = f.useState(null), x = f.useCallback((C) => {
  ...
  }, []), v = i || h, b = s || y, P = f.useRef(null), E = f.useRef(null), R = f.useRef(u), T = l != null, O = Qt(l), W = Qt(r), $ = f.useCallback(() => {
    ...
    W.current && (C.platform = W.current), Hn(P.current, E.current, C).then((N) => {
      ...
      k.current && !wt(R.current, L) && (R.current = L, Ot.flushSync(() => {
        d(L);
      }));
    });
  }, [m, e, n, W]);
...
var Wt = "Popper", [me, yo] = $e(Wt), [eo, he] = me(Wt), ge = (t) => {
...
ye.displayName = we;
var $t = "PopperContent", [no, oo] = me($t), xe = f.forwardRef(
  (t, e) => {
    var kt, _t, Ft, Bt, jt, It;
    const {
      __scopePopper: n,
      side: o = "bottom",
      sideOffset: r = 0,
      ...
      onPlaced: h,
      ...g
    } = t, y = he($t, n), [w, x] = f.useState(null), A = ct(e, (rt) => x(rt)), [v, b] = f.useState(null), P = to(v), E = (P == null ? void 0 : P.width) ?? 0, R = (P == null ? void 0 : P.height) ?? 0, T = o + (i !== "center" ? "-" + i : ""), O = typeof u == "number" ? u : { top: 0, right: 0, bottom: 0, left: 0, ...u }, W = Array.isArray(a) ? a : [a], $ = W.length > 0, k = {
      padding: O,
      ...
      middleware: [
        ...
        m && Zn({ strategy: "referenceHidden", ...k })
      ]
    }), [L, vt] = Ae(_), lt = et(h);
    Z(() => {
      C && (lt == null || lt());
    }, [C, lt]);
    const Ee = (kt = N.arrow) == null ? void 0 : kt.x, Pe = (_t = N.arrow) == null ? void 0 : _t.y, Ce = ((Ft = N.arrow) == null ? void 0 : Ft.centerOffset) !== 0, [Re, Oe] = f.useState();
    return Z(() => {
      ...
      "div",
      {
        ...
        style: {
          ...
          "--radix-popper-transform-origin": [
            (Bt = N.transformOrigin) == null ? void 0 : Bt.x,
