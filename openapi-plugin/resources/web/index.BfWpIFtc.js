import { e as s, v as D, V as M, a4 as N, j as p, w as R, x as P, U as B } from "./webapp.CeAUXIIl.js";
import { u as O } from "./index.BgEBtJ05.js";
function A(e) {
...
var v = "Checkbox", [H, X] = D(v), [K, L] = H(v), I = s.forwardRef(
  (e, o) => {
    const {
      ...
      onCheckedChange: k,
      ...E
    } = e, [n, x] = s.useState(null), g = M(o, (r) => x(r)), C = s.useRef(!1), y = n ? !!n.closest("form") : !0, [l = !1, m] = N({
      prop: f,
      defaultProp: c,
      onChange: k
    }), _ = s.useRef(l);
      ...
      /* @__PURE__ */ p.jsx(
        R.button,
        {
          ...
          onClick: P(e.onClick, (r) => {
            m((b) => a(b) ? !0 : !b), y && (C.current = r.isPropagationStopped(), C.current || r.stopPropagation());
          })
        }
      ),
      y && /* @__PURE__ */ p.jsx(
